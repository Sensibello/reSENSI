...
using reSENSIEngine.Services.Interfaces;
...
namespace reSENSIEngine.Services
{
	public class EventsProxy : IEventsProxy
	{
		...
		private void HandleConfigAppliedToSlot(BaseControllerVM controller, GamepadProfile gamepadProfile, Slot slot, reSENSI_CONTROLLER_PROFILE? profile)
		{
		...
		private void HandleSlotChanged(BaseControllerVM controller, GamepadProfile gamepadProfile, Slot slot, reSENSI_CONTROLLER_PROFILE? profile, bool physical)
		{
		...
		private void HandleShiftChanged(reSENSIHiddenServiceCommand command, GamepadProfile gamepadProfile, string name, BaseControllerVM controller, bool toggle)
		{
