...
namespace reSENSIEngine.Services.OverlayAPI
{
	public class OverlayMenuVME : ZBindableBase
	{
		...
		{
			switch (reSENSIOverlayMenuServiceCommand)
			{
			case 2:
			...
			case 5:
				...
				break;
			case 6:
				this.ArrowCommand(reSENSIOverlayMenuServiceCommand);
				return;
			case 7:
				this.ArrowCommand(reSENSIOverlayMenuServiceCommand);
				return;
		...
		private reSENSIOverlayMenuServiceCommand GetAlphaCommand(reSENSIOverlayMenuServiceCommand command)
		{
			reSENSIOverlayMenuServiceCommand reSENSIOverlayMenuServiceCommand = 0;
			...
			case 6:
				...
				{
					reSENSIOverlayMenuServiceCommand = 3;
				}
				else
				{
					reSENSIOverlayMenuServiceCommand = 2;
				}
				break;
			case 7:
				if (alphaActiveSector >= 180.0 && alphaActiveSector < 360.0)
			...
			return reSENSIOverlayMenuServiceCommand;
		}

		private void ArrowCommand(reSENSIOverlayMenuServiceCommand command)
		{
			...
			{
				reSENSIOverlayMenuServiceCommand alphaCommand;
		...
		private reSENSIOverlayMenuServiceCommand prevCommnad;

		private reSENSIOverlayMenuServiceCommand prevRemapedCommnad;
