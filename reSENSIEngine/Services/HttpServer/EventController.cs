...
using reSENSICommon.Network.HTTP.DataTransferObjects.Events;
...
namespace reSENSIEngine.Services.HttpServer
{
	...
	public class EventController : Controller
	{
		...
		private void OnConfigAppliedToSlotUI(BaseControllerVM controller, GamepadProfile gamepadProfile, Slot slot, reSENSI_CONTROLLER_PROFILE? profile)
		{
		...
		private void OnSlotChangedUI(BaseControllerVM controller, GamepadProfile gamepadProfile, Slot slot, reSENSI_CONTROLLER_PROFILE? profile, bool physical)
		{
