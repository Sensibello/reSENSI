...
using reSENSICommon.Infrastructure.LED;
using reSENSICommon.Interfaces;
...
using reSENSIEngine;
using reSENSIEngine.Utils.Extensions;
...
namespace XBEliteWPF.Services
{
	public class GamepadService : IGamepadService, IServiceInitedAwaitable, IAdminOperationsDeciderContainer
	{
		...
		public ObservableCollection<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> ServiceProfilesCollection { get; } = new ObservableCollection<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>();

		public ObservableCollection<reSENSI_CONTROLLER_PROFILE_CACHE> CachedProfilesCollection { get; } = new ObservableCollection<reSENSI_CONTROLLER_PROFILE_CACHE>();

		private ObservableCollection<reSENSI_STEAM_CONTROLLER_PROFILE_CACHE> CachedSteamProfilesCollection { get; } = new ObservableCollection<reSENSI_STEAM_CONTROLLER_PROFILE_CACHE>();

		private ObservableCollection<reSENSI_HIDDEN_APPLIED_PROFILE_CACHE> CachedHiddenAppliedProfilesCollection { get; } = new ObservableCollection<reSENSI_HIDDEN_APPLIED_PROFILE_CACHE>();
		...
		public reSENSI_CONTROLLER_PROFILE_EX GetProfileEx(ulong controllerID)
		{
			ObservableCollection<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> serviceProfilesCollection = this.ServiceProfilesCollection;
			Wrapper<reSENSI_CONTROLLER_PROFILE_EX> wrapper = ((serviceProfilesCollection != null) ? serviceProfilesCollection.FindWrapperByControllerID(controllerID) : null);
			if (wrapper == null)
			{
				return null;
			}
		...
		public reSENSI_CONTROLLER_PROFILE_EX GetProfileEx(string ID)
		{
			ObservableCollection<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> serviceProfilesCollection = this.ServiceProfilesCollection;
			Wrapper<reSENSI_CONTROLLER_PROFILE_EX> wrapper = ((serviceProfilesCollection != null) ? serviceProfilesCollection.FindWrapperByID(ID) : null);
			if (wrapper == null)
			{
				return null;
			}
		...
		public reSENSI_CONTROLLER_PROFILE_EX GetProfileExByServiceProfileId(ulong serviceProfileId)
		{
			ObservableCollection<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> serviceProfilesCollection = this.ServiceProfilesCollection;
			Wrapper<reSENSI_CONTROLLER_PROFILE_EX> wrapper = ((serviceProfilesCollection != null) ? serviceProfilesCollection.FindWrapperByServiceProfileId(serviceProfileId) : null);
			if (wrapper == null)
			{
				return null;
			}
		...
		public bool IsAnyServiceProfileWithExternalBluetooth()
		{
			...
			{
				return this.ServiceProfilesCollection.Any((Wrapper<reSENSI_CONTROLLER_PROFILE_EX> x) => x.Value.IsExternalBluetoothPresent());
			}
			return false;
		}
		...
		public bool IsAnyServiceProfileWithExternalBluetoothAdapter()
		{
			if (this.ServiceProfilesCollection != null)
			{
				return this.ServiceProfilesCollection.Any((Wrapper<reSENSI_CONTROLLER_PROFILE_EX> x) => x.Value.IsExternalBluetoothAdapterPresent());
			}
			return false;
		}
		...
		public bool IsAnyServiceProfileWithExternalSerialPort(string externalDeviceTypeId = "")
		{
			...
			{
				return this.ServiceProfilesCollection != null && this.ServiceProfilesCollection.Any((Wrapper<reSENSI_CONTROLLER_PROFILE_EX> x) => x.Value.IsExternalDeviceEqual(externalDeviceTypeId));
			}
			if (this.ServiceProfilesCollection != null)
			{
				return this.ServiceProfilesCollection.Any((Wrapper<reSENSI_CONTROLLER_PROFILE_EX> x) => x.Value.IsExternalDeviceWithSerialPortPresent());
			}
			return false;
		}
		...
		public List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> GetServiceProfileWithExternalBluetoothAdapter()
		{
			ObservableCollection<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> serviceProfilesCollection = this.ServiceProfilesCollection;
			...
			return serviceProfilesCollection.Where((Wrapper<reSENSI_CONTROLLER_PROFILE_EX> x) => x.Value.IsExternalBluetoothPresent() && !x.Value.IsExternalDeviceWithSerialPortPresent()).ToList<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>();
		}

		public List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> GetServiceProfileWithExternalBluetooth()
		{
			ObservableCollection<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> serviceProfilesCollection = this.ServiceProfilesCollection;
			if (serviceProfilesCollection == null)
			{
			...
			return serviceProfilesCollection.Where((Wrapper<reSENSI_CONTROLLER_PROFILE_EX> x) => x.Value.IsExternalBluetoothPresent()).ToList<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>();
		}

		public List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> GetServiceProfileWithExternalSerialPort()
		{
			ObservableCollection<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> serviceProfilesCollection = this.ServiceProfilesCollection;
			if (serviceProfilesCollection == null)
			{
			...
			return serviceProfilesCollection.Where((Wrapper<reSENSI_CONTROLLER_PROFILE_EX> x) => x.Value.IsExternalDeviceWithSerialPortPresent()).ToList<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>();
		}

		public List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> GetServiceProfileWithExternalDevice(ExternalDeviceType externalDeviceType)
		{
			if (externalDeviceType == null)
			{
		...
		{
			Wrapper<reSENSI_CONTROLLER_PROFILE_EX> wrapper = this.ServiceProfilesCollection.FindWrapperByID(controller.ID);
			if (wrapper == null)
			{
				return null;
			}
		...
		public GamepadService(IXBServiceCommunicator sc, IGameProfilesService gps, IEventAggregator ea, IAdminOperations ao, ILicensingService ls, IConfigFileService cfs, IUserSettingsService uss)
		{
			...
			BasereSENSIUserCommandInitializer.Init();
			...
			if (this.ExternalDevices.IsBluetoothExist)
			{
				...
				defaultInterpolatedStringHandler.AppendLiteral("   CanUseBluetoothInreSENSI ");
				defaultInterpolatedStringHandler.AppendFormatted<bool>(BluetoothUtils.CanUseBluetoothInreSENSI);
				...
				defaultInterpolatedStringHandler.AppendLiteral("   NeedInitForreSENSI ");
				defaultInterpolatedStringHandler.AppendFormatted<bool>(BluetoothUtils.NeedInitForreSENSI());
				Tracer.TraceWrite(defaultInterpolatedStringHandler.ToStringAndClear(), false);
		...
		{
			reSENSI_CONTROLLER_PROFILE_EX profileEx = this.GetProfileEx(gamepadId);
			if (profileEx != null)
			{
		...
		public async Task<bool> SwitchProfileToSlot(BaseControllerVM controller, Slot slot)
		{
			...
			else
			{
				...
				Wrapper<reSENSI_CONTROLLER_PROFILE_EX> wrapper = this.ServiceProfilesCollection.FirstOrDefault((Wrapper<reSENSI_CONTROLLER_PROFILE_EX> sp) => sp.Value.SlotsWrapperId == slotsWrapperId);
				if (wrapper == null)
				{
					flag = false;
				}
		...
		private async void ProcessProfilesChanged(WindowMessageEvent payload)
		{
			...
			ObservableCollection<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> oldServiceProfilesCollection = new ObservableCollection<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>(this.ServiceProfilesCollection);
			await this.RefreshServiceProfiles();
			List<reSENSI_CONTROLLER_PROFILE_EX> list = await this._xbServiceCommunicator.GetExclusiveCaptureProfilesList();
			this.IsExclusiveCaptureProfilePresent = list.Count > 0;
			List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> newProfileWrappers = this.ServiceProfilesCollection.Except(oldServiceProfilesCollection).ToList<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>();
			List<reSENSI_CONTROLLER_INFO> list2 = await this._xbServiceCommunicator.GetControllersList(true, false, false);
			List<reSENSI_CONTROLLER_INFO> hiddenControlers = UtilsCommon.GetHiddenControllers(list2);
			using (List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>.Enumerator enumerator = oldServiceProfilesCollection.Except(this.ServiceProfilesCollection).ToList<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>().GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					Wrapper<reSENSI_CONTROLLER_PROFILE_EX> wrapper2 = enumerator.Current;
					if (wrapper2.Value.Profiles.Any((reSENSI_CONTROLLER_PROFILE p) => reSENSI_CONTROLLER_PROFILE_Extensions.IsSlotWithUserConfig(p)))
					{
			...
			using (List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>.Enumerator enumerator = newProfileWrappers.GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					Wrapper<reSENSI_CONTROLLER_PROFILE_EX> wrapper = enumerator.Current;
					if (wrapper.Value.Profiles.Any((reSENSI_CONTROLLER_PROFILE p) => reSENSI_CONTROLLER_PROFILE_Extensions.IsSlotWithUserConfig(p)))
					{
		...
		private async void ProcessProfileStateChanged(WindowMessageEvent payload)
		{
			if (payload != null)
			{
				...
				if (num != 0UL)
				{
					reSENSI_CONTROLLER_PROFILE_EX profileEx = this.GetProfileExByServiceProfileId(num);
					if (profileEx != null)
					{
						reSENSI_CONTROLLER_PROFILE? reSENSI_CONTROLLER_PROFILE = profileEx.FindProfileById((ushort)num);
						if (reSENSI_CONTROLLER_PROFILE != null && reSENSI_CONTROLLER_PROFILE_Extensions.IsExternalDevicePresent(reSENSI_CONTROLLER_PROFILE.Value))
						{
							externalDeviceId = reSENSI_CONTROLLER_PROFILE_Extensions.GetExternalDeviceId(reSENSI_CONTROLLER_PROFILE.Value);
						}
					}
					if (flag5)
					{
		...
		private async void ProcessGyroCalibrationFinished(WindowMessageEvent payload)
		{
			...
			if (payload != null)
			{
				...
				Tracer.TraceWrite(defaultInterpolatedStringHandler.ToStringAndClear(), false);
				List<reSENSI_CONTROLLER_INFO> list = await this._xbServiceCommunicator.GetControllersList(false, false, false);
				if (list.Exists((reSENSI_CONTROLLER_INFO x) => x.Id == id))
				{
					reSENSI_CONTROLLER_INFO reSENSI_CONTROLLER_INFO = list.Find((reSENSI_CONTROLLER_INFO x) => x.Id == id);
					...
					defaultInterpolatedStringHandler.AppendFormatted<ulong>(id);
					RegistryHelper.SetValue(defaultInterpolatedStringHandler.ToStringAndClear(), "GyroXDelta", reSENSI_CONTROLLER_INFO.GyroXCalibrationDelta);
					defaultInterpolatedStringHandler = new DefaultInterpolatedStringHandler(1, 2);
					defaultInterpolatedStringHandler.AppendFormatted("Calibration");
					defaultInterpolatedStringHandler.AppendLiteral("\\");
					defaultInterpolatedStringHandler.AppendFormatted<ulong>(id);
					RegistryHelper.SetValue(defaultInterpolatedStringHandler.ToStringAndClear(), "GyroYDelta", reSENSI_CONTROLLER_INFO.GyroYCalibrationDelta);
					defaultInterpolatedStringHandler = new DefaultInterpolatedStringHandler(1, 2);
					defaultInterpolatedStringHandler.AppendFormatted("Calibration");
					defaultInterpolatedStringHandler.AppendLiteral("\\");
					defaultInterpolatedStringHandler.AppendFormatted<ulong>(id);
					RegistryHelper.SetValue(defaultInterpolatedStringHandler.ToStringAndClear(), "GyroZDelta", reSENSI_CONTROLLER_INFO.GyroZCalibrationDelta);
					...
					defaultInterpolatedStringHandler.AppendFormatted<long>(reSENSI_CONTROLLER_INFO.GyroXCalibrationDelta);
					defaultInterpolatedStringHandler.AppendLiteral(" / ");
					string text2 = defaultInterpolatedStringHandler.ToStringAndClear();
					defaultInterpolatedStringHandler = new DefaultInterpolatedStringHandler(14, 1);
					defaultInterpolatedStringHandler.AppendLiteral("GyroYDelta ");
					defaultInterpolatedStringHandler.AppendFormatted<long>(reSENSI_CONTROLLER_INFO.GyroYCalibrationDelta);
					defaultInterpolatedStringHandler.AppendLiteral(" / ");
					...
					defaultInterpolatedStringHandler.AppendFormatted<long>(reSENSI_CONTROLLER_INFO.GyroZCalibrationDelta);
		...
		private void SendPhysicalSlotChanged(BaseControllerVM controller, Slot slot)
		{
			...
			reSENSI_CONTROLLER_PROFILE_EX reSENSI_CONTROLLER_PROFILE_EX = this.ServiceProfilesCollection.FindByID(controller.ID);
			this.SaveSlot(controller.ShortID, slot);
			...
			onPhysicalSlotChanged(controller2, gamepadProfile, slot, (reSENSI_CONTROLLER_PROFILE_EX != null) ? new reSENSI_CONTROLLER_PROFILE?(reSENSI_CONTROLLER_PROFILE_EX.Profiles[slot]) : null, true);
		}
		...
		private void ProcessMacroCommand(WindowMessageEvent payload)
		{
			...
			if (payload != null)
			{
				...
				Tracer.TraceWrite(defaultInterpolatedStringHandler.ToStringAndClear(), false);
				BaseExecutablereSENSIUserCommand baseExecutablereSENSIUserCommand = (BaseExecutablereSENSIUserCommand)BasereSENSIUserCommand.reSENSI_USER_COMMAND_TABLE.FirstOrDefault(delegate(BasereSENSIUserCommand ruc)
				{
					BaseExecutablereSENSIUserCommand baseExecutablereSENSIUserCommand2 = ruc as BaseExecutablereSENSIUserCommand;
					return baseExecutablereSENSIUserCommand2 != null && baseExecutablereSENSIUserCommand2.CommandId == commandID;
				});
				if (baseExecutablereSENSIUserCommand == null)
				{
					return;
				}
				baseExecutablereSENSIUserCommand.Execute(num);
				Tracer.TraceWrite("ProcessMacroCommand: UserCommand Description " + baseExecutablereSENSIUserCommand.Description, false);
			}
		}
		...
		private void ProcessAmiiboUnloadByUid(WindowMessageEvent payload)
		{
			...
			if (payload != null)
			{
				...
				reSENSI_CONTROLLER_PROFILE_EX profile = this.ServiceProfilesCollection.FindByAmiiboUid(array);
				if (profile != null)
				{
					foreach (reSENSI_CONTROLLER_PROFILE_EX.AmiiboWrapper amiiboWrapper in profile.Amiibo)
					{
		...
		private async Task InitService()
		{
			try
			{
				ServiceResponseWrapper<reSENSI_GET_VERSION_RESPONSE> serviceResponseWrapper = await this._xbServiceCommunicator.GetVersion();
				if (serviceResponseWrapper.IsResponseValid)
				{
					if (serviceResponseWrapper.ServiceResponse.Header.Status == 0U && serviceResponseWrapper.ServiceResponse.Header.Size > 0U)
					{
						...
						if (flag)
						{
							DTMessageBox.Show("Service and app version mismatch. Please install the latest reSENSI version to continue.", MessageBoxButton.OK, MessageBoxImage.Hand, null, false, MessageBoxResult.None);
							Environment.Exit(0);
						}
					}
					await this.RefreshServiceProfiles();
			...
			if (BluetoothUtils.IsBluetoothExist() && Tracer.IsTextFileTraceEnabled)
			{
				...
				List<reSENSI_RADIO_INFO> list = await this._xbServiceCommunicator.GetRadioInfoList();
		...
		private async Task RefreshGamepadStatesAndReactOnBattery(ControllerVM gamepad, bool isUpdateControllerStateFromService)
		{
			try
			{
				if (ControllerTypeExtensions.IsGamepad(gamepad.ControllerType) && gamepad.IsOnline && !gamepad.IsDebugController && gamepad.ControllerBatteryKind != 3)
				{
					...
					{
						ServiceResponseWrapper<reSENSI_GET_CONTROLLER_STATE_RESPONSE> serviceResponseWrapper = await this._xbServiceCommunicator.GetControllerState(gamepad.ControllerId, gamepad.Type, false);
		...
		private void SetOnlineState(BaseControllerVM controller, bool onlineState)
		{
			...
			reSENSI_CONTROLLER_PROFILE_EX profileEx = this.GetProfileEx(controller.ID);
			if (profileEx != null)
			{
		...
		private async Task UpdateExistingControllers(List<reSENSI_CONTROLLER_INFO> realControllersList, List<reSENSI_CONTROLLER_INFO> controllersPeripheralForAdd, List<reSENSI_CONTROLLER_INFO> controllersForAdd, HashSet<CompositeControllerVM> changedComposites)
		{
			using (List<reSENSI_CONTROLLER_INFO>.Enumerator enumerator = realControllersList.GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					...
					if (realControllersList.Count((reSENSI_CONTROLLER_INFO x) => x.Id == CS$<>8__locals1.newItem.Id && ControllerTypeExtensions.IsSonyDS4OrDualSense(ControllerTypeExtensions.ConvertPhysicalTypeToEnum(0, x.Type, x.Id))) > 1)
					{
						this.DuplicateGamepadCollection.Add(new Tuple<ulong, uint>(CS$<>8__locals1.newItem.Id, CS$<>8__locals1.newItem.Type));
					}
					if (reSENSI_CONTROLLER_INFO_Extensions.IsPeripheral(CS$<>8__locals1.newItem))
					{
						controllersPeripheralForAdd.Add(CS$<>8__locals1.newItem);
					}
					else if (controllersForAdd.All((reSENSI_CONTROLLER_INFO item) => item.Id != CS$<>8__locals1.newItem.Id))
					{
					...
					foreach (BaseControllerVM existItem in this.GamepadCollection)
					{
						...
						if (existItem.IsConsideredTheSameControllerByID(CS$<>8__locals1.newItem.Id.ToString()) || (!flag2 && existItem.ContainerId == CS$<>8__locals1.newItem.ContainerId))
						{
							...
							ServiceResponseWrapper<reSENSI_GET_CONTROLLER_STATE_RESPONSE> serviceResponseWrapper = await this._xbServiceCommunicator.GetControllerState(CS$<>8__locals1.newItem.Id, CS$<>8__locals1.newItem.Type, false);
							if (serviceResponseWrapper.IsResponseValid && serviceResponseWrapper.ServiceResponse.Header.Status == 0U && serviceResponseWrapper.ServiceResponse.Header.Size > 0U)
							{
			...
			List<reSENSI_CONTROLLER_INFO>.Enumerator enumerator = default(List<reSENSI_CONTROLLER_INFO>.Enumerator);
		}

		private async Task AddPeripheralDevices(List<reSENSI_CONTROLLER_INFO> controllersPeripheralForAdd, HashSet<CompositeControllerVM> changedComposites)
		{
			using (IEnumerator<IGrouping<Guid, reSENSI_CONTROLLER_INFO>> enumerator = (from c in controllersPeripheralForAdd
				group c by c.ContainerId).GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					IGrouping<Guid, reSENSI_CONTROLLER_INFO> group = enumerator.Current;
					...
					using (IEnumerator<reSENSI_CONTROLLER_INFO> enumerator2 = group.GetEnumerator())
					{
						while (enumerator2.MoveNext())
						{
							reSENSI_CONTROLLER_INFO newItem = enumerator2.Current;
			...
			IEnumerator<IGrouping<Guid, reSENSI_CONTROLLER_INFO>> enumerator = null;
		}

		private async Task AddGamepadControllers(List<reSENSI_CONTROLLER_INFO> controllersForAdd, HashSet<CompositeControllerVM> changedComposites)
		{
			using (List<reSENSI_CONTROLLER_INFO>.Enumerator enumerator = controllersForAdd.GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					reSENSI_CONTROLLER_INFO newItem = enumerator.Current;
					if (this.BlacklistGamepads.FirstOrDefault((BlackListGamepad item) => item.ID == newItem.Id.ToString()) == null)
					{
						...
						ServiceResponseWrapper<reSENSI_GET_CONTROLLER_STATE_RESPONSE> serviceResponseWrapper = await this._xbServiceCommunicator.GetControllerState(newItem.Id, newItem.Type, false);
						if (serviceResponseWrapper.IsResponseValid && serviceResponseWrapper.ServiceResponse.Header.Status == 0U && serviceResponseWrapper.ServiceResponse.Header.Size > 0U)
						{
							controller.UpdateControllerState(serviceResponseWrapper.ServiceResponse);
						}
		...
		private async Task RemoveAddVirtualControllers(List<reSENSI_CONTROLLER_INFO> virtualControllersList)
		{
			foreach (ControllerVM controllerVM in new List<ControllerVM>(this.VirtualGamepadCollection))
			{
				...
				{
					foreach (reSENSI_CONTROLLER_INFO reSENSI_CONTROLLER_INFO in virtualControllersList)
					{
						if (controllerVM.ControllerId == reSENSI_CONTROLLER_INFO.Id)
						{
							flag = true;
							break;
						}
			...
			if (virtualControllersList.Count > 0)
			{
				foreach (reSENSI_CONTROLLER_INFO newVirtualItem in virtualControllersList)
				{
					bool flag2 = false;
					foreach (ControllerVM existVirtualItem in this.VirtualGamepadCollection)
					{
						...
						if (existVirtualItem.ControllerId == newVirtualItem.Id)
						{
							...
							ServiceResponseWrapper<reSENSI_GET_CONTROLLER_STATE_RESPONSE> serviceResponseWrapper = await this._xbServiceCommunicator.GetControllerState(newVirtualItem.Id, newVirtualItem.Type, false);
							if (serviceResponseWrapper.IsResponseValid && serviceResponseWrapper.ServiceResponse.Header.Status == 0U && serviceResponseWrapper.ServiceResponse.Header.Size > 0U)
							{
					...
					if (!flag2)
					{
						...
						ServiceResponseWrapper<reSENSI_GET_CONTROLLER_STATE_RESPONSE> serviceResponseWrapper2 = await this._xbServiceCommunicator.GetControllerState(newVirtualItem.Id, newVirtualItem.Type, false);
					...
					newVirtualItem = default(reSENSI_CONTROLLER_INFO);
				}
				List<reSENSI_CONTROLLER_INFO>.Enumerator enumerator3 = default(List<reSENSI_CONTROLLER_INFO>.Enumerator);
			}
		}
		...
		public async Task RefreshGamepadCollection(string ID = null)
		{
			...
			using (releaser2)
			{
				...
				List<reSENSI_CONTROLLER_INFO> list2;
				List<reSENSI_CONTROLLER_INFO> list = (list2 = await this._xbServiceCommunicator.GetControllersList(false, true, false));
				this.IsExclusiveCaptureControllersPresent = list2.Any((reSENSI_CONTROLLER_INFO x) => UtilsCommon.IsExclusiveCaptureControllerPhysicalType(x.Type));
				List<reSENSI_CONTROLLER_INFO> list3 = list.Where((reSENSI_CONTROLLER_INFO x) => x.ConnectionType != 3).ToList<reSENSI_CONTROLLER_INFO>();
				List<reSENSI_CONTROLLER_INFO> virtualControllersList = list.Where((reSENSI_CONTROLLER_INFO x) => x.ConnectionType == 3).ToList<reSENSI_CONTROLLER_INFO>();
				List<reSENSI_CONTROLLER_INFO> controllersForAdd = new List<reSENSI_CONTROLLER_INFO>();
				List<reSENSI_CONTROLLER_INFO> controllersPeripheralForAdd = new List<reSENSI_CONTROLLER_INFO>();
		...
		private void SetOfflineNonExistControllers(List<reSENSI_CONTROLLER_INFO> realControllersList)
		{
			List<BaseControllerVM> list = new List<BaseControllerVM>();
			using (IEnumerator<BaseControllerVM> enumerator = this.GamepadCollection.GetEnumerator())
			{
		...
		public async Task RefreshServiceProfileState(ulong serviceProfileId, int parameter)
		{
			...
			using (releaser2)
			{
				if (this.ServiceProfilesCollection != null)
				{
					reSENSI_CONTROLLER_PROFILE_EX profileEx = this.GetProfileExByServiceProfileId(serviceProfileId);
					if (profileEx != null)
					{
						ServiceResponseWrapper<reSENSI_GET_PROFILE_STATE_RESPONSE> serviceResponseWrapper = await this._xbServiceCommunicator.GetProfileState((ushort)serviceProfileId, false);
						if (serviceResponseWrapper.IsResponseValid)
						{
							int num = 0;
		...
		public async Task RefreshServiceProfiles()
		{
			...
			using (releaser2)
			{
				List<reSENSI_CONTROLLER_PROFILE_EX> list = await this._xbServiceCommunicator.GetProfilesList();
				foreach (Wrapper<reSENSI_CONTROLLER_PROFILE_EX> wrapper in new List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>(this.ServiceProfilesCollection))
				{
					bool flag = false;
					if (list.Count > 0)
					{
						foreach (reSENSI_CONTROLLER_PROFILE_EX reSENSI_CONTROLLER_PROFILE_EX in list)
						{
							if (wrapper.Value.SlotsWrapperId == reSENSI_CONTROLLER_PROFILE_EX.SlotsWrapperId)
							{
								flag = true;
								break;
							}
				...
				if (list.Count > 0)
				{
					List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> list2 = new List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>();
					using (List<reSENSI_CONTROLLER_PROFILE_EX>.Enumerator enumerator2 = list.GetEnumerator())
					{
						while (enumerator2.MoveNext())
						{
							reSENSI_CONTROLLER_PROFILE_EX newItem = enumerator2.Current;
							bool flag2 = false;
							using (IEnumerator<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> enumerator3 = this.ServiceProfilesCollection.GetEnumerator())
							{
								Func<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>, bool> <>9__0;
								while (enumerator3.MoveNext())
								{
									if (enumerator3.Current.Value.SlotsWrapperId == newItem.SlotsWrapperId)
									{
										IEnumerable<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> serviceProfilesCollection = this.ServiceProfilesCollection;
										Func<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>, bool> func;
										if ((func = <>9__0) == null)
										{
											Func<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>, bool> func2 = (Wrapper<reSENSI_CONTROLLER_PROFILE_EX> item) => item.Value.SlotsWrapperId == newItem.SlotsWrapperId;
											<>9__0 = func2;
											func = func2;
										}
										Wrapper<reSENSI_CONTROLLER_PROFILE_EX> wrapper2 = serviceProfilesCollection.First(func);
							...
							if (!flag2)
							{
								this.ServiceProfilesCollection.Add(new Wrapper<reSENSI_CONTROLLER_PROFILE_EX>(newItem));
							}
						}
					}
					if (list2.Any<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>())
					{
				...
				if (Engine.GamepadUdpServer != null)
				{
					...
					foreach (reSENSI_CONTROLLER_PROFILE_EX reSENSI_CONTROLLER_PROFILE_EX2 in list)
					{
						if (reSENSI_CONTROLLER_PROFILE_EX2.ProfilesState.Any((reSENSI_GET_PROFILE_STATE_RESPONSE x) => x.Enabled && x.VirtualType != 0U && reSENSI_GET_PROFILE_STATE_RESPONSE_Extension.IsUdpPresent(x)))
						{
							for (int i = 0; i < reSENSI_CONTROLLER_PROFILE_EX2.ProfilesState.Length; i++)
							{
								if (reSENSI_CONTROLLER_PROFILE_EX2.ProfilesState[i].Enabled && reSENSI_CONTROLLER_PROFILE_EX2.ProfilesState[i].VirtualType == 23U && reSENSI_GET_PROFILE_STATE_RESPONSE_Extension.IsUdpPresent(reSENSI_CONTROLLER_PROFILE_EX2.ProfilesState[i]))
								{
									currentIdsList.Add(reSENSI_CONTROLLER_PROFILE_EX2.ServiceProfileIds[i]);
								}
							}
						}
					}
		...
		public async Task RestoreDefaults(string ID, List<Slot> slots)
		{
			...
			if (gamepadProfiles != null)
			{
				...
				if (this.ServiceProfilesCollection.ContainsProfileForID(ID))
				{
					...
					{
						reSENSI_CONTROLLER_PROFILE_EX profileEx = this.ServiceProfilesCollection.FindByID(ID);
						if (profileEx != null)
						{
							await this._xbServiceCommunicator.DeleteProfiles(profileEx.GetAllProfileIds());
		...
		public bool IsAnyGamepadRemaped
		{
			get
			{
				return this.ServiceProfilesCollection.Any<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>();
			}
		}
		...
		private BaseControllerVM GetAssociatedController(reSENSI_CONTROLLER_PROFILE_EX controllerProfile)
		{
			reSENSI_CONTROLLER_PROFILE nonEmptyprofile = controllerProfile.Profiles.FirstOrDefault((reSENSI_CONTROLLER_PROFILE p) => reSENSI_CONTROLLER_PROFILE_Extensions.IsSlotWithUserConfig(p));
		...
		private async void OnServiceProfilesCollectionCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
		{
			...
			if (e.Action == NotifyCollectionChangedAction.Remove)
			{
				...
				{
					Wrapper<reSENSI_CONTROLLER_PROFILE_EX> wrapper = (Wrapper<reSENSI_CONTROLLER_PROFILE_EX>)obj;
			...
			if (e.Action == NotifyCollectionChangedAction.Add)
			{
				...
				{
					Wrapper<reSENSI_CONTROLLER_PROFILE_EX> wrapper2 = (Wrapper<reSENSI_CONTROLLER_PROFILE_EX>)obj2;
					GamepadService.<>c__DisplayClass239_1 CS$<>8__locals2 = new GamepadService.<>c__DisplayClass239_1();
					CS$<>8__locals2.<>4__this = this;
					reSENSI_CONTROLLER_PROFILE? profile = wrapper2.Value.GetCurrentSlotProfile();
					if (profile == null)
					{
					...
					else
					{
						...
						try
						{
							...
							if (this.AllPhysicalControllers.Any((BaseControllerVM x) => x.ControllerTypeEnums.Contains(36) || x.ControllerTypeEnums.Contains(26) || x.ControllerTypeEnums.Contains(54)) && ids.Length == types.Length)
							{
								...
								using (List<BaseControllerVM>.Enumerator enumerator3 = this.AllPhysicalControllers.Where((BaseControllerVM x) => x.ControllerTypeEnums.Any((ControllerTypeEnum y) => ControllerTypeExtensions.IsGamepadWithBuiltInAnyKeypad(y)) && CS$<>8__locals4.fullControllersList.Exists((reSENSI_CONTROLLER_INFO y) => y.ContainerId.Equals(x.ContainerId) && y.Type == 2147483650U)).ToList<BaseControllerVM>().GetEnumerator())
								{
									while (enumerator3.MoveNext())
									{
										BaseControllerVM gamepadWithBuiltInAnyKeypad = enumerator3.Current;
										foreach (reSENSI_CONTROLLER_INFO reSENSI_CONTROLLER_INFO in CS$<>8__locals4.fullControllersList.Where((reSENSI_CONTROLLER_INFO x) => x.ContainerId.Equals(gamepadWithBuiltInAnyKeypad.ContainerId) && x.Type == 2147483650U).ToList<reSENSI_CONTROLLER_INFO>())
										{
											for (int i = 0; i < ids.Length; i++)
											{
												if (ids[i] == reSENSI_CONTROLLER_INFO.Id && types[i] == 2147483650U)
												{
													ids[i] = 0UL;
												}
											}
								...
								using (List<BaseControllerVM>.Enumerator enumerator3 = this.AllPhysicalControllers.Where((BaseControllerVM x) => x.ControllerTypeEnums.Any((ControllerTypeEnum y) => ControllerTypeExtensions.IsGamepadWithBuiltInMouse(y)) && CS$<>8__locals4.fullControllersList.Exists((reSENSI_CONTROLLER_INFO y) => y.ContainerId.Equals(x.ContainerId) && y.Type == 2147483649U)).ToList<BaseControllerVM>().GetEnumerator())
								{
									while (enumerator3.MoveNext())
									{
										BaseControllerVM gamepadWithBuiltInMouse = enumerator3.Current;
										foreach (reSENSI_CONTROLLER_INFO reSENSI_CONTROLLER_INFO2 in CS$<>8__locals4.fullControllersList.Where((reSENSI_CONTROLLER_INFO x) => x.ContainerId.Equals(gamepadWithBuiltInMouse.ContainerId) && x.Type == 2147483649U).ToList<reSENSI_CONTROLLER_INFO>())
										{
											for (int j = 0; j < ids.Length; j++)
											{
												if (ids[j] == reSENSI_CONTROLLER_INFO2.Id && types[j] == 2147483649U)
												{
													ids[j] = 0UL;
												}
											}
				...
				else if (this.GamepadProfileRelations.ContainsKey(ID))
				{
					...
					catch (Exception ex2)
					{
						...
						if (isMobileClientRequest)
						{
							...
							{
								string text = ex2.Message.Split('\'', StringSplitOptions.None).FirstOrDefault((string x) => x.Contains(".reSENSI"));
			...
			using (releaser2)
			{
				...
				if (this.ServiceProfilesCollection.Count > 0)
				{
					...
					else
					{
						...
						reSENSI_CONTROLLER_PROFILE_EX profileEx = this.GetProfileEx(ID);
						if (profileEx != null)
						{
							reSENSI_CONTROLLER_PROFILE_EX.AmiiboWrapper[] amiibo = profileEx.Amiibo;
							bool flag;
							if (amiibo == null)
							{
								flag = false;
							...
							{
								flag = amiibo.Any((reSENSI_CONTROLLER_PROFILE_EX.AmiiboWrapper x) => x.AmiiboLoaded);
							}
							if (flag)
							{
								foreach (reSENSI_CONTROLLER_PROFILE_EX.AmiiboWrapper amiiboWrapper in profileEx.Amiibo)
								{
		...
		public async Task RefreshHiddenAppliedConfig()
		{
			...
			{
				List<reSENSI_CONTROLLER_INFO> allControllersList = await this._xbServiceCommunicator.GetControllersList(false, false, false);
				CS$<>8__locals1.allProfilesList = await this._xbServiceCommunicator.GetProfilesList();
				IEnumerable<reSENSI_CONTROLLER_INFO> enumerable = allControllersList.Where((reSENSI_CONTROLLER_INFO controller) => UtilsCommon.IsHiddenAppliedConfigControllerPhysicalType(controller.Type));
				Func<reSENSI_CONTROLLER_INFO, bool> func;
				if ((func = CS$<>8__locals1.<>9__1) == null)
				{
					GamepadService.<>c__DisplayClass246_0 CS$<>8__locals2 = CS$<>8__locals1;
					Func<reSENSI_CONTROLLER_INFO, bool> func2 = (reSENSI_CONTROLLER_INFO controller) => !CS$<>8__locals1.allProfilesList.Exists(delegate(reSENSI_CONTROLLER_PROFILE_EX x)
					{
						reSENSI_CONTROLLER_PROFILE[] profiles = x.Profiles;
						return profiles != null && profiles.Length != 0 && reSENSI_CONTROLLER_PROFILE_Extensions.IsControllerPresent(x.Profiles[0], controller.Id, (ulong)controller.Type);
					});
					CS$<>8__locals2.<>9__1 = func2;
					func = func2;
				}
				foreach (reSENSI_CONTROLLER_INFO reSENSI_CONTROLLER_INFO in enumerable.Where(func))
				{
					await this.CompileHiddenAppliedConfig(reSENSI_CONTROLLER_INFO.Id, reSENSI_CONTROLLER_INFO.Type, true);
				}
				IEnumerator<reSENSI_CONTROLLER_INFO> enumerator = null;
			}
		}
		...
		public async Task ProcessExclusiveCaptureProfile(string gamepadID, bool processDelete = true, bool processAdd = true)
		{
			...
			if (this.IsExclusiveCaptureControllersPresent && _currentGamepad != null)
			{
				...
				{
					List<reSENSI_CONTROLLER_PROFILE_EX> captureProfiles = await this._xbServiceCommunicator.GetExclusiveCaptureProfilesList();
					bool flag = false;
					if (processDelete)
					{
						using (IEnumerator<Tuple<ulong, SimpleDeviceInfo>> enumerator = this.SimpleDeviceInfoList.Where((Tuple<ulong, SimpleDeviceInfo> x) => UtilsCommon.IsExclusiveCaptureControllerPhysicalType(x.Item2.Type)).GetEnumerator())
						{
							while (enumerator.MoveNext())
							{
								...
								{
									IEnumerable<reSENSI_CONTROLLER_PROFILE_EX> enumerable = captureProfiles;
									Func<reSENSI_CONTROLLER_PROFILE_EX, bool> func;
									if ((func = CS$<>8__locals2.<>9__3) == null)
									{
										GamepadService.<>c__DisplayClass254_1 CS$<>8__locals3 = CS$<>8__locals2;
										Func<reSENSI_CONTROLLER_PROFILE_EX, bool> func2 = (reSENSI_CONTROLLER_PROFILE_EX x) => x.Profiles[0].Id[0] == CS$<>8__locals2.exclusiveSimpleDeviceInfo.Item1 && UtilsCommon.IsExclusiveCaptureControllerPhysicalType(x.Profiles[0].Type[0]);
										CS$<>8__locals3.<>9__3 = func2;
										func = func2;
									}
									foreach (reSENSI_CONTROLLER_PROFILE_EX reSENSI_CONTROLLER_PROFILE_EX in enumerable.Where(func))
									{
										...
										Tracer.TraceWrite(text + defaultInterpolatedStringHandler.ToStringAndClear(), false);
										await this._xbServiceCommunicator.DeleteProfile(reSENSI_CONTROLLER_PROFILE_EX.ServiceProfileIds[0]);
										flag = true;
									}
									IEnumerator<reSENSI_CONTROLLER_PROFILE_EX> enumerator2 = null;
								}
								CS$<>8__locals2 = null;
							}
						}
						...
						using (Dictionary<ulong, uint>.Enumerator enumerator3 = dictionary.GetEnumerator())
						{
							while (enumerator3.MoveNext())
							{
								...
								if (captureProfiles.Count > 0)
								{
									...
									Func<reSENSI_CONTROLLER_PROFILE, bool> <>9__5;
									flag2 = captureProfiles.Exists(delegate(reSENSI_CONTROLLER_PROFILE_EX x)
									{
										IEnumerable<reSENSI_CONTROLLER_PROFILE> profiles = x.Profiles;
										Func<reSENSI_CONTROLLER_PROFILE, bool> func3;
										if ((func3 = <>9__5) == null)
										{
											func3 = (<>9__5 = delegate(reSENSI_CONTROLLER_PROFILE profile)
											{
		...
		private async void CheckExclusiveCaptureProfilesOnGamepadChanged()
		{
			...
			List<reSENSI_CONTROLLER_PROFILE_EX> list = await this._xbServiceCommunicator.GetExclusiveCaptureProfilesList();
			List<reSENSI_CONTROLLER_PROFILE_EX> captureProfiles = list;
			if (captureProfiles.Count > 0)
			{
				List<reSENSI_CONTROLLER_INFO> allControllersList = await this._xbServiceCommunicator.GetControllersList(false, false, false);
				foreach (reSENSI_CONTROLLER_PROFILE_EX reSENSI_CONTROLLER_PROFILE_EX in captureProfiles.Where((reSENSI_CONTROLLER_PROFILE_EX profile) => UtilsCommon.IsExclusiveCaptureControllerPhysicalType(profile.Profiles[0].Type[0])))
				{
					ulong id = reSENSI_CONTROLLER_PROFILE_EX.Profiles[0].Id[0];
					if (!allControllersList.Any((reSENSI_CONTROLLER_INFO x) => x.Id == id))
					{
				...
				IEnumerator<reSENSI_CONTROLLER_PROFILE_EX> enumerator = null;
		...
		public void TraceProfileState(ulong serviceProfileId, ref reSENSI_GET_PROFILE_STATE_RESPONSE profileState)
		{
		...
		private async Task<ushort> EnableRemap(GamepadProfiles gamepadProfiles, bool showGuiMessages, bool changeGamepadSlot, int slotNumber = -1, bool force = false, bool reenableRemap = false, EnableRemapBundle enableRemapBundle = null, EnableRemapResponse enableRemapResponse = null, bool isCacheAllowed = true)
		{
			...
			List<reSENSI_CONTROLLER_INFO> fullControllersList = null;
			...
			bool flag = true;
			reSENSI_CONTROLLER_PROFILE_CACHE? reSENSI_CONTROLLER_PROFILE_CACHE = null;
			if (isCacheAllowed)
			{
				...
				{
					reSENSI_CONTROLLER_PROFILE_CACHE = this.TryGetCachedProfile(CS$<>8__locals1.gamepadProfiles.SlotProfiles, CS$<>8__locals1.controllerIds, controllerTypes, isCacheAllowed);
					if (reSENSI_CONTROLLER_PROFILE_CACHE != null)
					{
						flag = false;
					}
					else
			...
			reSENSI_CONTROLLER_PROFILE_EX controllerProfileEx = ((!flag) ? reSENSI_CONTROLLER_PROFILE_CACHE.Value.ControllerProfileEx : reSENSI_CONTROLLER_PROFILE_EX.CreateBlankInstance(0U));
			Slot? firstSlotWithConfig = ((!flag) ? reSENSI_CONTROLLER_PROFILE_CACHE.Value.FirstSlotWithConfig : null);
			List<uint> virtualGamepadList = ((!flag) ? reSENSI_CONTROLLER_PROFILE_CACHE.Value.VirtualGamepadList : new List<uint>());
			...
			if (flag)
			{
				...
				{
					Slot slot = (Slot)obj2;
					reSENSI_CONTROLLER_PROFILE controllerProfile = reSENSI_CONTROLLER_PROFILE.CreateBlankInstance();
					...
					if (flag5 && flag4)
					{
						...
						if (!flag6)
						{
							...
							bool flag9 = false;
							if ((ulong)num4 >= (ulong)MacroCompiler.MaxreSENSIMacroTableSize)
							{
								flag9 = true;
								...
								defaultInterpolatedStringHandler.AppendLiteral(" >= ");
								defaultInterpolatedStringHandler.AppendFormatted<long>(MacroCompiler.MaxreSENSIMacroTableSize);
							...
							if (num3 >= 2048U)
							{
								...
								defaultInterpolatedStringHandler.AppendLiteral(" >= reSENSI_MAX_MACROS ");
							...
							if (array != null && array.Length != 0 && (ulong)num2 + (ulong)((long)array.Length) >= (ulong)MacroCompiler.MaxreSENSIMacroTableSize)
							{
								Tracer.TraceWrite("GamepadService.EnableRemapAsync: Error! MACRO_TABLE_SIZE " + MacroCompiler.MaxreSENSIMacroTableSize.ToString() + " < TotalMacroSize " + ((long)((ulong)num2 + (ulong)((long)array.Length))).ToString(), false);
								if (!flag9)
								{
						...
						if (flag6)
						{
							if (reSENSI_CONTROLLER_PROFILE_Extensions.IsUdpPresent(controllerProfile) && Engine.GamepadUdpServer != null)
							{
					...
					{
						controllerProfile = reSENSI_CONTROLLER_PROFILE_Extensions.FillControllerInfos(controllerProfile, controllerInfos, Engine.UserSettingsService, this.DuplicateGamepadCollection, false, fullControllersList, false, false, null, this.SimpleDeviceInfoList);
						uint num5 = num2;
						uint num6 = 0U;
						...
						if (array2 != null && array2.Length != 0)
						{
							...
							Tracer.TraceWrite(defaultInterpolatedStringHandler.ToStringAndClear(), false);
							if ((ulong)num5 + (ulong)((long)array2.Length) < (ulong)MacroCompiler.MaxreSENSIMacroTableSize)
							{
					...
					if (controllerProfile.VirtualType != 0U && !reSENSI_CONTROLLER_PROFILE_Extensions.IsExternalDevicePresent(controllerProfile))
					{
						...
						if (controllerProfile.Type.Any((uint x) => x == 100U || x == 101U || x == 102U || x == 268435455U))
						{
							for (int l = 0; l < controllerProfile.Type.Length; l++)
							{
								if (controllerProfile.Type[l] == 100U || controllerProfile.Type[l] == 101U || controllerProfile.Type[l] == 102U || controllerProfile.Type[l] == 268435455U)
								{
									...
									{
										reSENSI_BUTTON_MASK[] stopMacrosMask = controllerProfile.StopMacrosMask;
										int num8 = 0;
									...
									{
										reSENSI_BUTTON_MASK[] stopMacrosMask2 = controllerProfile.StopMacrosMask;
										int num9 = 1;
									...
									{
										reSENSI_BUTTON_MASK[] stopMacrosMask3 = controllerProfile.StopMacrosMask;
										int num10 = 2;
									...
									{
										reSENSI_BUTTON_MASK[] stopMacrosMask4 = controllerProfile.StopMacrosMask;
										int num11 = 3;
					...
					if (reSENSI_CONTROLLER_PROFILE_Extensions.IsExternalDevicePresent(controllerProfile))
					{
						ExternalDeviceType type = 1000;
						if (reSENSI_CONTROLLER_PROFILE_Extensions.IsExternalBluetoothAdapterPresent(controllerProfile))
						{
							type = 0;
						}
						if (reSENSI_CONTROLLER_PROFILE_Extensions.IsExternalDeviceWithSerialPortPresent(controllerProfile))
						{
							type = 1;
						}
						if (reSENSI_CONTROLLER_PROFILE_Extensions.IsExternalDeviceWithBluetoothPresent(controllerProfile) && reSENSI_CONTROLLER_PROFILE_Extensions.IsExternalDeviceWithSerialPortPresent(controllerProfile))
						{
							type = 2;
						}
						List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> serviceProfileWithExternalDevice = this.GetServiceProfileWithExternalDevice(type);
						if (serviceProfileWithExternalDevice != null)
						{
							foreach (Wrapper<reSENSI_CONTROLLER_PROFILE_EX> wrapper in serviceProfileWithExternalDevice)
							{
								bool flag10 = false;
								if (wrapper.Value.IsExternalDevicePresent(type))
								{
									foreach (reSENSI_CONTROLLER_PROFILE reSENSI_CONTROLLER_PROFILE in wrapper.Value.Profiles)
									{
										if (reSENSI_CONTROLLER_PROFILE_Extensions.IsExternalDeviceEqual(reSENSI_CONTROLLER_PROFILE, reSENSI_CONTROLLER_PROFILE_Extensions.GetExternalDeviceId(controllerProfile)))
										{
											foreach (ulong num12 in reSENSI_CONTROLLER_PROFILE.Id.Where((ulong x) => x > 0UL).ToList<ulong>())
											{
							...
							List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>.Enumerator enumerator3 = default(List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>>.Enumerator);
						}
					}
					...
					controllerProfile = default(reSENSI_CONTROLLER_PROFILE);
				}
				...
				if (!anyProfileFound)
				{
					...
					{
						reSENSI_CONTROLLER_PROFILE_EX reSENSI_CONTROLLER_PROFILE_EX = this.ServiceProfilesCollection.FindByID(gamepad.ID);
						if (reSENSI_CONTROLLER_PROFILE_EX != null)
						{
							if (reSENSI_CONTROLLER_PROFILE_EX.ServiceProfileIds.Any((ushort x) => x > 0))
							{
								await this._xbServiceCommunicator.DeleteProfiles(reSENSI_CONTROLLER_PROFILE_EX.GetAllProfileIds());
							}
						}
					}
				...
				if (isCacheAllowed)
				{
					...
					this.CachedProfilesCollection.Add(new reSENSI_CONTROLLER_PROFILE_CACHE(CS$<>8__locals1.controllerIds, controllerTypes, slotInfoList, firstSlotWithConfig, virtualGamepadList, controllerProfileEx));
				}
				slotInfoList = null;
			}
			BaseControllerVM existingGamepad = null;
			Slot slotToSwitch = 0;
			reSENSI_CONTROLLER_PROFILE_EX oldProfileEx = null;
			...
			else
			{
				if (controllerTypes.Any((ControllerTypeEnum x) => ControllerTypeExtensions.IsAnySteam(x) || ControllerTypeExtensions.IsAnyAzeron(x) || ControllerTypeExtensions.IsFlydigi(x)))
				{
					...
					while (CS$<>8__locals4.i < controllerTypes.Length)
					{
						...
						{
							IEnumerable<reSENSI_CONTROLLER_PROFILE_EX> enumerable = captureProfiles;
							Func<reSENSI_CONTROLLER_PROFILE_EX, bool> func5;
							if ((func5 = CS$<>8__locals4.<>9__28) == null)
							{
								GamepadService.<>c__DisplayClass267_1 CS$<>8__locals5 = CS$<>8__locals4;
								Func<reSENSI_CONTROLLER_PROFILE_EX, bool> func6 = (reSENSI_CONTROLLER_PROFILE_EX x) => x.Profiles[0].Id[0] == CS$<>8__locals4.CS$<>8__locals1.controllerIds[CS$<>8__locals4.i] && UtilsCommon.IsExclusiveCaptureControllerPhysicalType(x.Profiles[0].Type[0]);
								CS$<>8__locals5.<>9__28 = func6;
								func5 = func6;
							}
							foreach (reSENSI_CONTROLLER_PROFILE_EX reSENSI_CONTROLLER_PROFILE_EX2 in enumerable.Where(func5))
							{
								...
								await this._xbServiceCommunicator.DeleteProfile(reSENSI_CONTROLLER_PROFILE_EX2.ServiceProfileIds[0]);
							}
							IEnumerator<reSENSI_CONTROLLER_PROFILE_EX> enumerator5 = null;
						}
				...
				{
					List<reSENSI_CONTROLLER_PROFILE_EX> captureProfiles = await this._xbServiceCommunicator.GetHiddenAppliedConfigsList();
					...
					while (CS$<>8__locals6.i < controllerTypes.Length)
					{
						...
						{
							IEnumerable<reSENSI_CONTROLLER_PROFILE_EX> enumerable2 = captureProfiles;
							Func<reSENSI_CONTROLLER_PROFILE_EX, bool> func7;
							if ((func7 = CS$<>8__locals6.<>9__29) == null)
							{
								GamepadService.<>c__DisplayClass267_2 CS$<>8__locals7 = CS$<>8__locals6;
								Func<reSENSI_CONTROLLER_PROFILE_EX, bool> func8 = (reSENSI_CONTROLLER_PROFILE_EX x) => x.Profiles[0].Id[0] == CS$<>8__locals6.CS$<>8__locals2.controllerIds[CS$<>8__locals6.i] && UtilsCommon.IsHiddenAppliedConfigControllerPhysicalType(x.Profiles[0].Type[0]);
								CS$<>8__locals7.<>9__29 = func8;
								func7 = func8;
							}
							foreach (reSENSI_CONTROLLER_PROFILE_EX reSENSI_CONTROLLER_PROFILE_EX3 in enumerable2.Where(func7))
							{
								...
								await this._xbServiceCommunicator.DeleteProfile(reSENSI_CONTROLLER_PROFILE_EX3.ServiceProfileIds[0]);
							}
							IEnumerator<reSENSI_CONTROLLER_PROFILE_EX> enumerator5 = null;
						}
				...
				while (i < 4)
				{
					...
					if (oldProfileEx != null)
					{
						...
						if (i == slotToSwitch)
						{
							disconnectFromNintendoConsole = controllerProfileEx.Profiles[i].Enabled && reSENSI_CONTROLLER_PROFILE_Extensions.IsExternalDeviceWithBluetoothPresent(controllerProfileEx.Profiles[i]) && reSENSI_CONTROLLER_PROFILE_Extensions.IsExternalConsoleFlagPresent(controllerProfileEx.Profiles[i]) && reSENSI_CONTROLLER_PROFILE_Extensions.IsExternalDeviceWithBluetoothPresent(oldProfileEx.Profiles[i]) && reSENSI_CONTROLLER_PROFILE_Extensions.IsExternalConsoleFlagPresent(oldProfileEx.Profiles[i]) && controllerProfileEx.Profiles[i].VirtualType == 48U && (controllerProfileEx.Profiles[i].SwitchProLeftStickDeadzone != oldProfileEx.Profiles[i].SwitchProLeftStickDeadzone || controllerProfileEx.Profiles[i].SwitchProRightStickDeadzone != oldProfileEx.Profiles[i].SwitchProRightStickDeadzone);
							if (ControllerTypeExtensions.ConvertPhysicalTypesToEnums(0, controllerProfileEx.ControllerPhysicalTypes, null).Any((ControllerTypeEnum x) => ControllerTypeExtensions.IsAnySonyDualSense(x)))
							{
								...
								if (reSENSI_CONTROLLER_PROFILE_Extensions.IsSlotWithLeftAdaptiveTriggerSettings(oldProfileEx.Profiles[i]) && !reSENSI_CONTROLLER_PROFILE_Extensions.IsSlotWithLeftAdaptiveTriggerSettings(controllerProfileEx.Profiles[i]))
								{
									resetAdaptiveLeftTrigger = true;
								}
								if (reSENSI_CONTROLLER_PROFILE_Extensions.IsSlotWithRightAdaptiveTriggerSettings(oldProfileEx.Profiles[i]) && !reSENSI_CONTROLLER_PROFILE_Extensions.IsSlotWithRightAdaptiveTriggerSettings(controllerProfileEx.Profiles[i]))
								{
									resetAdaptiveRightTrigger = true;
								}
								if (!resetAdaptiveLeftTrigger)
								{
									if (controllerProfileEx.Profiles.All((reSENSI_CONTROLLER_PROFILE x) => !reSENSI_CONTROLLER_PROFILE_Extensions.IsSlotWithLeftAdaptiveTriggerSettings(x)))
									{
										if (oldProfileEx.Profiles.Any((reSENSI_CONTROLLER_PROFILE x) => reSENSI_CONTROLLER_PROFILE_Extensions.IsSlotWithLeftAdaptiveTriggerSettings(x)))
										{
											resetAdaptiveLeftTrigger = true;
										}
									}
								...
								{
									if (controllerProfileEx.Profiles.All((reSENSI_CONTROLLER_PROFILE x) => !reSENSI_CONTROLLER_PROFILE_Extensions.IsSlotWithRightAdaptiveTriggerSettings(x)))
									{
										if (oldProfileEx.Profiles.Any((reSENSI_CONTROLLER_PROFILE x) => reSENSI_CONTROLLER_PROFILE_Extensions.IsSlotWithRightAdaptiveTriggerSettings(x)))
										{
											resetAdaptiveRightTrigger = true;
										}
									}
								...
								if (resetAdaptiveLeftTrigger || resetAdaptiveRightTrigger)
								{
									...
									while (indexDualSense < ControllerTypeExtensions.ConvertPhysicalTypesToEnums(0, oldProfileEx.ControllerPhysicalTypes, null).Length)
									{
										...
										{
											TaskAwaiter<ServiceResponseWrapper<reSENSI_SET_ADAPTIVE_TRIGGERS_RESPONSE>> taskAwaiter3 = this._xbServiceCommunicator.SetAdaptiveTrigger(CS$<>8__locals1.controllerIds[indexDualSense], oldProfileEx.ControllerPhysicalTypes[indexDualSense], resetAdaptiveLeftTrigger, resetAdaptiveRightTrigger, resetAdaptiveLeftTrigger ? resetTriggerPacket : null, resetAdaptiveRightTrigger ? resetTriggerPacket : null, 0).GetAwaiter();
											if (!taskAwaiter3.IsCompleted)
											{
												await taskAwaiter3;
												TaskAwaiter<ServiceResponseWrapper<reSENSI_SET_ADAPTIVE_TRIGGERS_RESPONSE>> taskAwaiter4;
												taskAwaiter3 = taskAwaiter4;
												taskAwaiter4 = default(TaskAwaiter<ServiceResponseWrapper<reSENSI_SET_ADAPTIVE_TRIGGERS_RESPONSE>>);
											}
					...
					ServiceResponseWrapper<reSENSI_ADD_PROFILE_RESPONSE> serviceResponseWrapper2 = await this._xbServiceCommunicator.AddProfile(controllerProfileEx.Profiles[i], controllerTypes, oldProfileId, flags, showGuiMessages, enableRemapBundle, enableRemapResponse, false);
				...
				else
				{
								...
								while (num20 < controllerProfileEx.SlotManagerProfile.Id.Length)
								{
									if (controllerProfileEx.SlotManagerProfile.Id[num20] == 0UL && controllerProfileEx.SlotManagerProfile.Id[num20] == 0UL)
									{
										...
										if (tuple != null)
										{
											...
											reSENSI_CONTROLLER_PROFILE_EX reSENSI_CONTROLLER_PROFILE_EX4 = controllerProfileEx;
											reSENSI_CONTROLLER_PROFILE_EX4.SlotManagerProfile.ExclusiveControllersMask = reSENSI_CONTROLLER_PROFILE_EX4.SlotManagerProfile.ExclusiveControllersMask | (ushort)(1 << num20);
					...
					ServiceResponseWrapper<reSENSI_ADD_PROFILE_RESPONSE> serviceResponseWrapper3 = await this._xbServiceCommunicator.AddProfile(controllerProfileEx.SlotManagerProfile, controllerTypes, oldProfileId, flags, showGuiMessages, enableRemapBundle, enableRemapResponse, false);
		...
		public async Task ReCompileSteamLizardProfile()
		{
			...
			if (this.IsExclusiveCaptureProfilePresent)
			{
				...
				if (captureProfiles.Count > 0)
				{
					foreach (reSENSI_CONTROLLER_PROFILE_EX reSENSI_CONTROLLER_PROFILE_EX in captureProfiles.Where((reSENSI_CONTROLLER_PROFILE_EX profile) => profile.Profiles[0].Type[0] == 140U || profile.Profiles[0].Type[0] == 141U))
					{
						await this.CompileExclusiveCaptureProfile(reSENSI_CONTROLLER_PROFILE_EX.Profiles[0].Id[0], reSENSI_CONTROLLER_PROFILE_EX.Profiles[0].Type[0], true);
					}
					IEnumerator<reSENSI_CONTROLLER_PROFILE_EX> enumerator = null;
				}
			}
		...
		public async Task CompileHiddenAppliedConfig(ulong controllerId, uint type, bool enabled = true)
		{
			...
			if (!ControllerTypeExtensions.IsAnyEngineController(controllerTypeEnum) || this._licensingService.IsMobileControllerFeatureUnlocked)
			{
				...
				{
					reSENSI_HIDDEN_APPLIED_PROFILE_CACHE? reSENSI_HIDDEN_APPLIED_PROFILE_CACHE = null;
					...
					{
						reSENSI_HIDDEN_APPLIED_PROFILE_CACHE = this.TryGetCachedHiddenAppliedProfile(controllerId);
						if (reSENSI_HIDDEN_APPLIED_PROFILE_CACHE != null)
						{
							flag = false;
						}
						else
					...
					reSENSI_CONTROLLER_PROFILE reSENSI_CONTROLLER_PROFILE = ((!flag) ? reSENSI_HIDDEN_APPLIED_PROFILE_CACHE.Value.ControllerProfile : reSENSI_CONTROLLER_PROFILE.CreateBlankInstance());
					if (flag)
					{
						uint num = 0U;
						bool isSlotFeatureUnlocked = this._licensingService.IsSlotFeatureUnlocked;
						...
						Buffer.BlockCopy(MacroCompilerVirtualMouse.CalculateVirtualMouseDelta(), 0, reSENSI_CONTROLLER_PROFILE.Macros, (int)MacroCompiler.CalculateMouseDeltaOffset, (int)MacroCompiler.MouseDeltaSize);
						Buffer.BlockCopy(MacroCompiler.VirtualGamepadLeftStickUpdate(), 0, reSENSI_CONTROLLER_PROFILE.Macros, (int)MacroCompiler.VirtualGamepadLeftStickUpdateOffset, (int)MacroCompiler.VirtualGamepadStickUpdateSize);
						Buffer.BlockCopy(MacroCompiler.VirtualGamepadRightStickUpdate(), 0, reSENSI_CONTROLLER_PROFILE.Macros, (int)MacroCompiler.VirtualGamepadRightStickUpdateOffset, (int)MacroCompiler.VirtualGamepadStickUpdateSize);
						reSENSI_CONTROLLER_PROFILE.Macros[0] = 0;
						reSENSI_CONTROLLER_PROFILE.Macros[1] = 1;
						reSENSI_CONTROLLER_PROFILE.Macros[3] = 2;
						reSENSI_CONTROLLER_PROFILE.Macros[5] = 3;
						reSENSI_CONTROLLER_PROFILE.Macros[7] = 4;
						reSENSI_CONTROLLER_PROFILE.Macros[8] = 0;
						...
						if (!flag4)
						{
							if ((ulong)num2 >= (ulong)MacroCompiler.MaxreSENSIMacroTableSize)
							{
							...
							if (array3.Length != 0 && 55L + (long)array3.Length >= MacroCompiler.MaxreSENSIMacroTableSize)
							{
								Tracer.TraceWrite("CompileHiddenAppliedConfig: Error! MACRO_TABLE_SIZE " + MacroCompiler.MaxreSENSIMacroTableSize.ToString() + " < TotalMacroSize " + (55L + (long)array3.Length).ToString(), false);
							}
							return;
						}
						...
						this.CachedHiddenAppliedProfilesCollection.Add(new reSENSI_HIDDEN_APPLIED_PROFILE_CACHE(controllerId, controllerTypeEnum, reSENSI_CONTROLLER_PROFILE));
					}
					reSENSI_CONTROLLER_PROFILE.Id[0] = controllerId;
					reSENSI_CONTROLLER_PROFILE.Type[0] = type;
					reSENSI_CONTROLLER_PROFILE.BroadcastFlags = 0;
					reSENSI_CONTROLLER_PROFILE.DeleteAfterPipeDisconnect = true;
					reSENSI_CONTROLLER_PROFILE.HiddenControllersMask = 0;
					reSENSI_CONTROLLER_PROFILE.Enabled = enabled;
					reSENSI_CONTROLLER_PROFILE.GuiContext = 262144UL;
					await this._xbServiceCommunicator.AddProfile(reSENSI_CONTROLLER_PROFILE, array, 0, 0, false, null, null, false);
		...
		public async Task<bool> ApplyHoneypotProfile(SpecialProfileInfo specialProfileInfo)
		{
			...
			else
			{
				...
				IL_167:
				ControllerTypeEnum[] array = new ControllerTypeEnum[15];
				reSENSI_CONTROLLER_PROFILE reSENSI_CONTROLLER_PROFILE = reSENSI_CONTROLLER_PROFILE.CreateBlankInstance();
				reSENSI_CONTROLLER_PROFILE.VirtualType = num;
				defaultInterpolatedStringHandler = new DefaultInterpolatedStringHandler(43, 1);
				...
				defaultInterpolatedStringHandler.AppendFormatted<uint>(num);
				Tracer.TraceWrite(defaultInterpolatedStringHandler.ToStringAndClear(), false);
				reSENSI_CONTROLLER_PROFILE.RemoteBthAddr = 279280282174469UL;
				...
				defaultInterpolatedStringHandler.AppendFormatted<ulong>(reSENSI_CONTROLLER_PROFILE.RemoteBthAddr, "X");
				Tracer.TraceWrite(defaultInterpolatedStringHandler.ToStringAndClear(), false);
				reSENSI_CONTROLLER_PROFILE.VirtualFlags = b;
				...
				defaultInterpolatedStringHandler.AppendFormatted<byte>(reSENSI_CONTROLLER_PROFILE.VirtualFlags);
				Tracer.TraceWrite(defaultInterpolatedStringHandler.ToStringAndClear(), false);
				reSENSI_CONTROLLER_PROFILE.GuiContext = 131072UL;
				reSENSI_CONTROLLER_PROFILE.BroadcastFlags = 0;
				reSENSI_CONTROLLER_PROFILE.DeleteAfterPipeDisconnect = true;
				reSENSI_CONTROLLER_PROFILE.Enabled = true;
				if (externalDeviceType == 2)
				{
					text = text.ToUpper();
					char[] array2 = text.ToCharArray();
					reSENSI_CONTROLLER_PROFILE.GimxBaudRate = 500000U;
					for (int i = 0; i < text.Length; i++)
					{
						reSENSI_CONTROLLER_PROFILE.GimxPortName[i] = array2[i];
					}
					...
					defaultInterpolatedStringHandler.AppendFormatted<uint>(reSENSI_CONTROLLER_PROFILE.GimxBaudRate);
					Tracer.TraceWrite(defaultInterpolatedStringHandler.ToStringAndClear(), false);
				}
				ServiceResponseWrapper<reSENSI_ADD_PROFILE_RESPONSE> serviceResponseWrapper = await this._xbServiceCommunicator.AddProfile(reSENSI_CONTROLLER_PROFILE, array, 0, 0, false, null, null, true);
				if (serviceResponseWrapper.IsResponseValid)
				{
					string text2;
		...
		private reSENSI_CONTROLLER_PROFILE_CACHE? TryGetCachedProfile(SlotProfilesDictionary slotProfilesDictionary, IReadOnlyList<ulong> controllerIds, IReadOnlyList<ControllerTypeEnum> controllerTypes, bool isCacheAllowed)
		{
			if (!isCacheAllowed)
			{
				reSENSI_CONTROLLER_PROFILE_CACHE? reSENSI_CONTROLLER_PROFILE_CACHE = null;
				return reSENSI_CONTROLLER_PROFILE_CACHE;
			}
			if (this.CachedProfilesCollection.Count == 0)
			{
				reSENSI_CONTROLLER_PROFILE_CACHE? reSENSI_CONTROLLER_PROFILE_CACHE = null;
			...
			foreach (reSENSI_CONTROLLER_PROFILE_CACHE reSENSI_CONTROLLER_PROFILE_CACHE2 in this.CachedProfilesCollection)
			{
				if (reSENSI_CONTROLLER_PROFILE_CACHE2.ControllerIds.Length == controllerIds.Count && reSENSI_CONTROLLER_PROFILE_CACHE2.ControllerTypes.Length == controllerTypes.Count && reSENSI_CONTROLLER_PROFILE_CACHE2.SlotInfoList.Count == list.Count)
				{
					IEnumerable<ulong> controllerIds2 = reSENSI_CONTROLLER_PROFILE_CACHE2.ControllerIds;
					...
					if (!flag)
					{
						IEnumerable<ControllerTypeEnum> controllerTypes2 = reSENSI_CONTROLLER_PROFILE_CACHE2.ControllerTypes;
						...
						if (!flag)
						{
							for (int l = 0; l < reSENSI_CONTROLLER_PROFILE_CACHE2.SlotInfoList.Count; l++)
							{
								if (reSENSI_CONTROLLER_PROFILE_CACHE2.SlotInfoList[l].Slot != list[l].Slot || reSENSI_CONTROLLER_PROFILE_CACHE2.SlotInfoList[l].ConfigPath != list[l].ConfigPath || reSENSI_CONTROLLER_PROFILE_CACHE2.SlotInfoList[l].ConfigPathMd5 != list[l].ConfigPathMd5)
								{
									flag = true;
									break;
								}
							...
							if (!flag)
							{
								...
								reSENSI_CONTROLLER_PROFILE_EX controllerProfileEx = reSENSI_CONTROLLER_PROFILE_CACHE2.ControllerProfileEx;
								if (((controllerProfileEx != null) ? controllerProfileEx.Profiles : null) != null)
								{
									for (int j = 0; j < reSENSI_CONTROLLER_PROFILE_CACHE2.ControllerProfileEx.Profiles.Length; j++)
									{
										reSENSI_CONTROLLER_PROFILE_CACHE2.ControllerProfileEx.Profiles[j].Enabled = false;
									}
								}
								reSENSI_CONTROLLER_PROFILE_EX controllerProfileEx2 = reSENSI_CONTROLLER_PROFILE_CACHE2.ControllerProfileEx;
								if (((controllerProfileEx2 != null) ? controllerProfileEx2.Enabled : null) != null)
								{
									for (int k = 0; k < reSENSI_CONTROLLER_PROFILE_CACHE2.ControllerProfileEx.Enabled.Length; k++)
									{
										reSENSI_CONTROLLER_PROFILE_CACHE2.ControllerProfileEx.Enabled[k] = false;
									}
								}
								return new reSENSI_CONTROLLER_PROFILE_CACHE?(reSENSI_CONTROLLER_PROFILE_CACHE2);
							}
						}
					}
				}
		...
		private reSENSI_STEAM_CONTROLLER_PROFILE_CACHE? TryGetCachedSteamProfile(ulong controllerId)
		{
			if (this.CachedSteamProfilesCollection.Count == 0)
			{
				return null;
			}
			foreach (reSENSI_STEAM_CONTROLLER_PROFILE_CACHE reSENSI_STEAM_CONTROLLER_PROFILE_CACHE in this.CachedSteamProfilesCollection)
			{
				if (reSENSI_STEAM_CONTROLLER_PROFILE_CACHE.ControllerId == controllerId && ControllerTypeExtensions.IsAnySteam(reSENSI_STEAM_CONTROLLER_PROFILE_CACHE.ControllerType))
				{
					...
					Tracer.TraceWrite(defaultInterpolatedStringHandler.ToStringAndClear(), false);
					return new reSENSI_STEAM_CONTROLLER_PROFILE_CACHE?(reSENSI_STEAM_CONTROLLER_PROFILE_CACHE);
				}
			}
			return null;
		}

		private reSENSI_HIDDEN_APPLIED_PROFILE_CACHE? TryGetCachedHiddenAppliedProfile(ulong controllerId)
		{
			if (this.CachedHiddenAppliedProfilesCollection.Count == 0)
			{
				return null;
			}
			foreach (reSENSI_HIDDEN_APPLIED_PROFILE_CACHE reSENSI_HIDDEN_APPLIED_PROFILE_CACHE in this.CachedHiddenAppliedProfilesCollection)
			{
				if (reSENSI_HIDDEN_APPLIED_PROFILE_CACHE.ControllerId == controllerId && ControllerTypeExtensions.IsAllowedHiddenAppliedConfig(reSENSI_HIDDEN_APPLIED_PROFILE_CACHE.ControllerType))
				{
					...
					defaultInterpolatedStringHandler.AppendFormatted<ulong>(controllerId, "X");
					Tracer.TraceWrite(defaultInterpolatedStringHandler.ToStringAndClear(), false);
					return new reSENSI_HIDDEN_APPLIED_PROFILE_CACHE?(reSENSI_HIDDEN_APPLIED_PROFILE_CACHE);
				}
			}
			return null;
		}

		private static void UpdateSimpleDeviceInfoList(List<Tuple<ulong, SimpleDeviceInfo>> simpleDeviceInfoList, ref List<reSENSI_CONTROLLER_INFO> controllerList)
		{
			...
			List<reSENSI_CONTROLLER_INFO> list = controllerList.Where((reSENSI_CONTROLLER_INFO x) => x.ConnectionType != 3).ToList<reSENSI_CONTROLLER_INFO>();
			int i;
			Predicate<reSENSI_CONTROLLER_INFO> <>9__2;
			int j;
			for (i = 0; i < simpleDeviceInfoList.Count; i = j + 1)
			{
				List<reSENSI_CONTROLLER_INFO> list2 = list;
				Predicate<reSENSI_CONTROLLER_INFO> predicate;
				if ((predicate = <>9__2) == null)
				{
					predicate = (<>9__2 = (reSENSI_CONTROLLER_INFO x) => x.Id == simpleDeviceInfoList[i].Item1 && x.Type == simpleDeviceInfoList[i].Item2.Type);
				}
			...
			using (List<reSENSI_CONTROLLER_INFO>.Enumerator enumerator = list.GetEnumerator())
			{
				while (enumerator.MoveNext())
				{
					reSENSI_CONTROLLER_INFO controller = enumerator.Current;
