...
{
	public class reSENSIGamepadsServiceAPI : BasicDeviceColorChanger
	{
		...
		{
			reSENSIGamepadsServiceAPI.<>c__DisplayClass11_0 CS$<>8__locals1 = new reSENSIGamepadsServiceAPI.<>c__DisplayClass11_0();
			...
			if (settings.IsBatteryColorIndicationAllowed)
			{
				...
				{
					reSENSIGamepadsServiceAPI.<>c__DisplayClass11_0.<<SetBatteryNotification>b__1>d <<SetBatteryNotification>b__1>d;
					...
					<<SetBatteryNotification>b__1>d.<>t__builder.Start<reSENSIGamepadsServiceAPI.<>c__DisplayClass11_0.<<SetBatteryNotification>b__1>d>(ref <<SetBatteryNotification>b__1>d);
				});
			}
			else
			{
				...
				{
					reSENSIGamepadsServiceAPI.<>c__DisplayClass11_0.<<SetBatteryNotification>b__0>d <<SetBatteryNotification>b__0>d;
					...
					<<SetBatteryNotification>b__0>d.<>t__builder.Start<reSENSIGamepadsServiceAPI.<>c__DisplayClass11_0.<<SetBatteryNotification>b__0>d>(ref <<SetBatteryNotification>b__0>d);
				});
				flag = true;
			}
			return flag;
