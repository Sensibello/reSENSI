...
namespace XBEliteWPF.Services.Interfaces
{
	public interface IGamepadService : IServiceInitedAwaitable
	{
		...
		ObservableCollection<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> ServiceProfilesCollection { get; }
		...
		ObservableCollection<reSENSI_CONTROLLER_PROFILE_CACHE> CachedProfilesCollection { get; }
		...
		reSENSI_CONTROLLER_PROFILE_EX GetProfileEx(ulong controllerID);

		reSENSI_CONTROLLER_PROFILE_EX GetProfileEx(string ID);
		...
		List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> GetServiceProfileWithExternalBluetooth();

		List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> GetServiceProfileWithExternalBluetoothAdapter();

		List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> GetServiceProfileWithExternalSerialPort();

		List<Wrapper<reSENSI_CONTROLLER_PROFILE_EX>> GetServiceProfileWithExternalDevice(ExternalDeviceType externalDeviceType);

		reSENSI_CONTROLLER_PROFILE_EX GetProfileExByServiceProfileId(ulong serviceProfileId);
