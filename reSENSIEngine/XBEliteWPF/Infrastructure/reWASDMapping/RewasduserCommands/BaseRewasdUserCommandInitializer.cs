...
namespace XBEliteWPF.Infrastructure.reSENSIMapping.reSENSIuserCommands
{
		...
		public static void Init()
		{
			if (BasereSENSIUserCommand.reSENSI_USER_COMMAND_TABLE == null)
			{
				List<BasereSENSIUserCommand[]> list = new List<BasereSENSIUserCommand[]> { new BasereSENSIUserCommand[]
				{
					...
					new CMDUserCommand(3, "COMMAND_CLOSE_reSENSI_GUI", 11660, "Remove", "taskkill /im reSENSI.exe"),
					...
					new MacroUserCommand(10, "COMMAND_TURN_ANTIBOSS_MODE", 11668, "UriUserCommandAntibossMode", new List<BasereSENSIMapping>
					{
