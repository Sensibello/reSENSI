...
using reSENSICommon.Infrastructure.SupportedControllers.Base;
...
namespace XBEliteWPF.Infrastructure.Controller
{
	public class ControllerVM : BaseControllerVM
	{
		...
		public ControllerVM(reSENSI_CONTROLLER_INFO controllerInfo, bool isDebugController = false)
			: base(isDebugController)
		{
			this._controllerInfo = reSENSI_CONTROLLER_INFO.CreateBlankInstance();
			this._controllerState = default(reSENSI_GET_CONTROLLER_STATE);
		...
		public override bool UpdateControllerInfo(reSENSI_CONTROLLER_INFO controllerInfo)
		{
		...
		public override void UpdateControllerState(reSENSI_GET_CONTROLLER_STATE_RESPONSE controllerState)
		{
		...
		public override bool IsBluetoothConnectionFlagPresent
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsBluetoothConnection(this._controllerInfo);
			}
		}
		...
		public override bool IsAnalogTriggersPresent
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsAnalogTriggersPresent(this._controllerInfo);
			}
		}
		...
		public override bool IsMotorRumbleMotorPresent
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsMotorRumbleMotorPresent(this._controllerInfo);
			}
		}
		...
		public override bool IsTriggerRumbleMotorPresent
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsTriggerRumbleMotorPresent(this._controllerInfo) && !ControllerTypeExtensions.IsRazerWolverine2(this.ControllerType);
			}
		}
		...
		public override bool IsAdaptiveTriggersPresent
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsAdaptiveTriggersPresent(this._controllerInfo);
			}
		}
		...
		public override bool IsSteamExtendedPresent
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsSteamExtendedPresent(this._controllerInfo);
			}
		}
		...
		public override bool IsAccelerometerPresent
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsAccelerometerPresent(this._controllerInfo);
			}
		}
		...
		public override bool IsGyroscopePresent
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsGyroscopePresent(this._controllerInfo);
			}
		}
		...
		public override bool IsTouchpadPresent
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsTouchpadPresent(this._controllerInfo);
			}
		}
		...
		public override bool IsTiltMode2
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsTiltMode2(this._controllerInfo);
			}
		}
		...
		public override bool IsControllerExclusiveAccessSupported
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsControllerExclusiveAccessSupported(this._controllerInfo);
			}
		}
		...
		public override bool IsRightHandDevice
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsRightHandDevice(this._controllerInfo);
			}
		}
		...
		public bool IsPowerManagementEnabled
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsPowerManagementEnabled(this._controllerInfo);
			}
		}
		...
		public bool IsPowerDownSupported
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsPowerDownSupported(this._controllerInfo);
			}
		}
		...
		public bool IsControllerPropertyChatpad
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsControllerPropertyChatpad(this._controllerInfo);
			}
		}
		...
		public bool IsControllerPhysicalOutputAndDebug
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsControllerPhysicalOutputAndDebug(this._controllerInfo);
			}
		}
		...
		public bool IsControllerSupportHardwareGyroCalibration
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsControllerSupportHardwareGyroCalibration(this._controllerInfo);
			}
		}
		...
		public bool IsControllerGyroAutomaticCalibrationDisabled
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsControllerGyroAutomaticCalibrationDisabled(this._controllerInfo);
			}
		}
		...
		public bool IsMonochromeLed
		{
			get
			{
				return !this.HasAnyEngineControllers && this.IsLedPresent && reSENSI_CONTROLLER_INFO_Extensions.IsMonochromeLed(this._controllerInfo);
			}
		}
		...
		public bool IsMasterAddressPresent
		{
			get
			{
				return reSENSI_CONTROLLER_INFO_Extensions.IsMasterAddressPresent(this._controllerInfo);
			}
		}
		...
		public void TraceControllerInfo(string traceWriteTag = " - Controllers")
		{
			...
			if ((this.Type == 2147483648U || this.Type == 2147483649U) && reSENSI_CONTROLLER_INFO_Extensions.IsKeyboardMouseInput(this._controllerInfo))
			{
		...
		private reSENSI_CONTROLLER_INFO _controllerInfo;

		private reSENSI_GET_CONTROLLER_STATE _controllerState;
