...
{
	public delegate void ControllerSlotChangedHandler(BaseControllerVM controller, GamepadProfile gamepadProfile, Slot slot, reSENSI_CONTROLLER_PROFILE? profile, bool physical);
}
