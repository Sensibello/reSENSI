...
using reSENSIEngine;
using reSENSIEngine.OverlayAPI;
...
namespace DTOverlay
{
	public class OverlayMenuE
	{
		...
		public void ShowMenu(BaseControllerVM controller, GamepadProfile gamepadProfile, string iID, bool toggle)
		{
			...
			reSENSI_CONTROLLER_PROFILE_EX reSENSI_CONTROLLER_PROFILE_EX = Engine.GamepadService.ServiceProfilesCollection.FindByID(iID);
		...
		public void ExecuteOverlayMenuCommand(reSENSIOverlayMenuServiceCommand reSENSIOverlayMenuServiceCommand)
		{
			if (this.menuWindow != null)
			{
				...
				menuvm.ExecuteOverlayMenuCommand(reSENSIOverlayMenuServiceCommand);
			}
		}
