...
namespace DTOverlay
{
	public class OverlayMenuCircleE : ZBindableBase
	{
		...
		public bool SetActiveCommand(reSENSIOverlayMenuServiceCommand reSENSIOverlayMenuServiceCommand)
		{
			...
			{
				flag = this.CurrentSector.Submenu.SetActiveCommand(reSENSIOverlayMenuServiceCommand);
			}
			return flag;
		}
