    ...
    public class SVGGamepadWithAllAnnotations : UserControl, IComponentConnector
    {
        ...
        private void InitContainerGrid()
        {
            ...
            foreach (XBBinding item2 in XBBindings.Where((XBBinding x) => x.IsNotEmpty))
            {
                ...
                string name = reSENSIUI.Utils.XBUtil.XBUtils.ConvertGamepadButtonToAnchorString(item2.GamepadButton) + "Annotation";
        ...
        public void InitializeComponent()
        {
            ...
            {
                _contentLoaded = true;
                Uri resourceLocator = new Uri("/reSENSI;component/controls/fastconfigrenders/svggamepadwithallannotations.xaml", UriKind.Relative);
