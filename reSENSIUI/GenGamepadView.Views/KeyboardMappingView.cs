...
namespace GenGamepadView.Views
{
    public class KeyboardMappingView : UserControl, IComponentConnector
    {
        ...
        private FrameworkElementFactory CreateDataTemplaleFactory()
        {
            ...
            {
                Converter = new BasereSENSIMappingAnnotationIconConverter(),
        ...
        public void InitializeComponent()
        {
            ...
            {
                _contentLoaded = true;
                Uri resourceLocator = new Uri("/reSENSI;component/controls/fastconfigrenders/keyboardmappingview.xaml", UriKind.Relative);
