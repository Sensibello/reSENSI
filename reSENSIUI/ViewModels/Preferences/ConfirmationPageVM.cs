...
namespace reSENSIUI.ViewModels.Preferences
{
	public class ConfirmationPageVM : PreferencesBaseVM
	{
		...
		public override Task Initialize()
		{
			...
			this.RemindSteamLimitation = RegistryHelper.GetValue(RegistryHelper.CONFIRMATION_REG_PATH, "RemindSteamIgnorereSENSI", 1, false) == 1;
		...
		public override Task<bool> ApplyChanges()
		{
			...
			RegistryHelper.SetValue(RegistryHelper.CONFIRMATION_REG_PATH, "RemindSteamIgnorereSENSI", Convert.ToInt32(this.RemindSteamLimitation));
