...
using reSENSICommon.Network.HTTP;
...
namespace reSENSIUI.ViewModels
{
	public class CommunityConfigsViewVM : ZBindableBase
	{
		...
		private async Task GetConfigsList()
		{
			...
			CS$<>8__locals1.resp = null;
			CS$<>8__locals1.requestStr = string.Format("https://software-api.reSENSI.com/configs/search?game_id={0}&gamepad={1}", this.CurrentGame.Id, this.GetCurrentControllerType());
			await this.ExecDownloadProcess(true, delegate
			{
		...
		private void OpenCommunity()
		{
			if (this.CurrentGame != null)
			{
				Process.Start(new ProcessStartInfo("https://www.reSENSI.com/community/games/" + this.CurrentGame.Url)
				{
		...
		private const string COMMUNITY_GAME_URL = "https://www.reSENSI.com/community/games/";

		private const string TOP_GAMES_URL = "https://software-api.reSENSI.com/games/top?limit=6";

		private const string GAMES_LIST_URL = "https://software-api.reSENSI.com/games/suggestions?query=";

		private const string CONFIGS_LIST_URL = "https://software-api.reSENSI.com/configs/search?game_id={0}&gamepad={1}";

		public const string CONFIG_DOWNLOAD_URL = "https://reSENSI.com/community/config/download?hash=";

		public const string GAME_IMAGE_URL = "https://img.cdn.reSENSI.com";
