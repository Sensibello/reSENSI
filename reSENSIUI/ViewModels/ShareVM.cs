	...
	public class ShareVM : ZBindable
	{
		...
		private async void ShareConfig()
		{
			...
			else
			{
				...
				string text3 = Uri.EscapeDataString(Convert.ToBase64String(Encoding.UTF8.GetBytes(this._configVM.Name + ".reSENSI")));
				...
				while (nextAttempt)
				{
					...
					try
					{
						...
						num2 = bytes.Length;
						HttpWebRequest httpWebRequest = (HttpWebRequest)WebRequest.Create("http://store.reSENSI.com/config/v2");
