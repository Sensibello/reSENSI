...
namespace reSENSIUI.ViewModels.SecondaryWindows.AddExternalDeviceWizard
{
	internal class EspStage1VM : BasePageVM
	{
		...
		private void SetBaseTexts(bool checkingFirmware)
		{
			...
			this.WaitingConnectDescription = string.Concat(new string[]
			{
				...
				Environment.NewLine,
				"<a href=\"https://help.reSENSI.com/external-devices/esp32-bluetooth-adapter.html#native_drivers\">",
		...
		private void SetErrorTexts()
		{
			...
			this.WaitingConnectDescription = DTLocalization.GetString(12658) + Environment.NewLine + Environment.NewLine + string.Format(DTLocalization.GetString(12681), this._wizard.Result.DeviceType, "https://help.reSENSI.com/external-devices/esp32-bluetooth-adapter.html#adapter-wasn't-detected");
		}
		...
		private async void CheckFirmware()
		{
			...
			try
			{
				if (this.SpHandler.Open())
				{
					...
					bool flag;
					bool flag2;
					if (this.SpHandler.CheckForreSENSIFirmwareVersion(ref num, ref flag, ref flag2))
					{
