...
using reSENSIDownloader;
using reSENSIUI.Utils.WebUtils;
	...
	internal class EspToolDownloader
	{
		...
		public void Download()
		{
			...
			if (toolDownloaderVM != null)
			{
				...
				toolDownloaderVM.Message = string.Format(DTLocalization.GetString(12683), "https://help.reSENSI.com/external-devices/esp32-bluetooth-adapter.html#esptool");
				toolDownloaderVM.DownloadingMessage = DTLocalization.GetString(12686);
				toolDownloaderVM.FailedDescription = string.Format(DTLocalization.GetString(12685), "https://help.reSENSI.com/external-devices/esp32-bluetooth-adapter.html#esptool-download");
