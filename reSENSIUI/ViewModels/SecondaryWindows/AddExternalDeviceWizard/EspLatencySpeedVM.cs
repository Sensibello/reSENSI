...
namespace reSENSIUI.ViewModels.SecondaryWindows.AddExternalDeviceWizard
{
	internal class EspLatencySpeedVM : BasePageVM
	{
		...
		public string LatencySpeedDescription
		{
			get
			{
				return string.Format(DTLocalization.GetString(12663), this._wizard.Result.Alias + " (" + this._wizard.Result.SerialPort + ")", "https://help.reSENSI.com/external-devices/esp32-bluetooth-adapter.html#latency-timer");
			}
		}
