...
namespace reSENSIUI.License.Pages
{
	internal class BaseLicensePage : ZBindableBase
	{
		...
		{
			return "https://www.daemon-tools.cc/cart/buy_check?abbr=reSENSI&utm_campaign=reSENSI2&utm_source=app&utm_medium=license";
		}
		...
		{
			DSUtils.GoUrl("https://www.daemon-tools.cc/cart/buy_check?abbr=reSENSI&utm_campaign=reSENSI2&utm_source=app&utm_medium=license");
