...
namespace reSENSIUI.Services
{
	public class KeyBindingService : ZBindable, IKeyBindingService
	{
		...
		public ObservableCollection<BasereSENSIMapping> reSENSIMappingsCollection
		{
			get
			{
				return this._reSENSIMappingsCollection;
			}
			set
			{
				this._reSENSIMappingsCollection = value;
				this.OnPropertyChanged("reSENSIMappingsCollection");
			}
		}
		...
		public ObservableCollection<BasereSENSIMapping> reSENSIMappingsCollectionWithoutMouseAndScrolls
		{
			get
			{
				return this._reSENSIMappingsCollectionWithoutMouseAndScrolls;
			}
			set
			{
				this._reSENSIMappingsCollectionWithoutMouseAndScrolls = value;
				this.OnPropertyChanged("reSENSIMappingsCollectionWithoutMouseAndScrolls");
			}
		}

		public ObservableCollection<BasereSENSIMapping> reSENSIMappingsCollectionWithDoNotInherit
		{
			get
			{
				return this._reSENSIMappingsCollectionWithDoNotInherit;
			}
			set
			{
				this._reSENSIMappingsCollectionWithDoNotInherit = value;
				this.OnPropertyChanged("reSENSIMappingsCollectionWithDoNotInherit");
			}
		}

		public ObservableCollection<BasereSENSIMapping> reSENSIMappingsCollectionWithoutMouseAndScrollsWithDoNotInherit
		{
			get
			{
				return this._reSENSIMappingsCollectionWithoutMouseAndScrollsWithDoNotInherit;
			}
			set
			{
				this._reSENSIMappingsCollectionWithoutMouseAndScrollsWithDoNotInherit = value;
				this.OnPropertyChanged("reSENSIMappingsCollectionWithoutMouseAndScrollsWithDoNotInherit");
			}
		}
		...
		public KeyBindingService(IGameProfilesService gps, IEventAggregator ea)
		{
			...
			this.RecreateKeyScanCodeCollectionForreSENSIMappings(0);
		...
		public void RecreateKeyScanCodeCollectionForreSENSIMappings(VirtualGamepadType virtualGamepadType = 0)
		{
			...
			List<BasereSENSIMapping> list = enumerable.OfType<BasereSENSIMapping>().ToList<BasereSENSIMapping>();
			list.AddRange(BasereSENSIUserCommand.reSENSI_USER_COMMAND_TABLE);
			list.Remove(noMap);
			list.Remove(noInheritance);
			list.Insert(0, noMap);
			this.reSENSIMappingsCollection = new ObservableCollection<BasereSENSIMapping>(list);
			this.reSENSIMappingsCollectionWithDoNotInherit = new ObservableCollection<BasereSENSIMapping>(this.reSENSIMappingsCollection);
			this.reSENSIMappingsCollectionWithDoNotInherit.Insert(1, noInheritance);
			List<BasereSENSIMapping> list2 = (from ksc in KeyScanCodeV2.SCAN_CODE_TABLE
				where !string.IsNullOrWhiteSpace(ksc.FriendlyName) && ksc.PCKeyCategory != 1 && ksc.PCKeyCategory != 2
				orderby ksc.IsMouse descending
				select ksc).OfType<BasereSENSIMapping>().ToList<BasereSENSIMapping>();
			list2.AddRange(BasereSENSIUserCommand.reSENSI_USER_COMMAND_TABLE);
			list2.Remove(noMap);
			list2.Remove(noInheritance);
			list2.Insert(0, noMap);
			this.reSENSIMappingsCollectionWithoutMouseAndScrolls = new ObservableCollection<BasereSENSIMapping>(list2);
			this.reSENSIMappingsCollectionWithoutMouseAndScrollsWithDoNotInherit = new ObservableCollection<BasereSENSIMapping>(this.reSENSIMappingsCollectionWithoutMouseAndScrolls);
			this.reSENSIMappingsCollectionWithoutMouseAndScrollsWithDoNotInherit.Insert(1, noInheritance);
		}
		...
		private ObservableCollection<BasereSENSIMapping> _reSENSIMappingsCollection;
		...
		private ObservableCollection<BasereSENSIMapping> _reSENSIMappingsCollectionWithoutMouseAndScrolls;

		private ObservableCollection<BasereSENSIMapping> _reSENSIMappingsCollectionWithDoNotInherit;

		private ObservableCollection<BasereSENSIMapping> _reSENSIMappingsCollectionWithoutMouseAndScrollsWithDoNotInherit;
