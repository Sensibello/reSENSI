...
namespace reSENSIUI.Controls.DeadZoneSlider
{
    public class ZoneMultiSlider : UserControl, IComponentConnector
    {
        ...
        public void InitializeComponent()
        {
            ...
            {
                _contentLoaded = true;
                Uri resourceLocator = new Uri("/reSENSI;component/controls/deadzoneslider/zonemultislider.xaml", UriKind.Relative);
