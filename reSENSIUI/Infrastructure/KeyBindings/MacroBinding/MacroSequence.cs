...
namespace reSENSIUI.Infrastructure.KeyBindings.MacroBinding
{
	public class MacroSequence : SortableObservableCollection<BaseMacro>, IDisposable
	{
		...
		{
			reSENSIApplicationCommands.CopyMacroSequence(this);
		}
		...
		private bool CopySelectedItemsCanExecute()
		{
			...
			bool flag4 = flag3;
			return reSENSIApplicationCommands.CanCopyMacroSequence(this) && (this.IsHoldUntilRelease || flag4 || (this.IsMultiSelectedItems && flag2));
		}
		...
		private void PasteItems(bool isHotkeys)
		{
			...
			reSENSIApplicationCommands.PasteMacroSequence(this, num);
			this.IsChanged = true;
			PropertyChangedEventHandler macroSequencePropertyChanged = this.MacroSequencePropertyChanged;
			if (macroSequencePropertyChanged == null)
			{
		...
		private void ReplaceSelectedItems()
		{
			...
			if (baseMacro != null)
			{
				reSENSIApplicationCommands.ReplaceMacroSequence(this, base.IndexOf(baseMacro) + 1);
			}
		}
