...
namespace reSENSIUI.Infrastructure.KeyBindings.XBBindingDirectionalGroups
{
	public abstract class BaseDirectionalGroup : ZBindableBase, IIndexable
	{
		...
		public bool IsBoundToOverlayMenuDirections
		{
			get
			{
				return this.UpDirectionValue.SingleActivator.MappedKey.IsUserCommand && ((BasereSENSIUserCommand)this.UpDirectionValue.SingleActivator.MappedKey).CommandId == 134 && this.DownDirectionValue.SingleActivator.MappedKey.IsUserCommand && ((BasereSENSIUserCommand)this.DownDirectionValue.SingleActivator.MappedKey).CommandId == 135 && this.LeftDirectionValue.SingleActivator.MappedKey.IsUserCommand && ((BasereSENSIUserCommand)this.LeftDirectionValue.SingleActivator.MappedKey).CommandId == 137 && this.RightDirectionValue.SingleActivator.MappedKey.IsUserCommand && ((BasereSENSIUserCommand)this.RightDirectionValue.SingleActivator.MappedKey).CommandId == 136;
			}
		}
		...
		{
			this.LeftDirectionValue.SingleActivator.MappedKey = BasereSENSIUserCommand.reSENSI_USER_COMMAND_TABLE.First((BasereSENSIUserCommand x) => x.CommandId == 137);
			this.RightDirectionValue.SingleActivator.MappedKey = BasereSENSIUserCommand.reSENSI_USER_COMMAND_TABLE.First((BasereSENSIUserCommand x) => x.CommandId == 136);
			this.UpDirectionValue.SingleActivator.MappedKey = BasereSENSIUserCommand.reSENSI_USER_COMMAND_TABLE.First((BasereSENSIUserCommand x) => x.CommandId == 134);
			this.DownDirectionValue.SingleActivator.MappedKey = BasereSENSIUserCommand.reSENSI_USER_COMMAND_TABLE.First((BasereSENSIUserCommand x) => x.CommandId == 135);
			this.UpdateProperties();
		}
