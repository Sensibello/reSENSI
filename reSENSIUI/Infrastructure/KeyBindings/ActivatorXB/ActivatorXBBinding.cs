...
using reSENSIUI.Infrastructure.KeyBindings.Mask;
...
namespace reSENSIUI.Infrastructure.KeyBindings.ActivatorXB
{
	public class ActivatorXBBinding : ZBindable
	{
		...
		public BasereSENSIMapping MappedKey
		{
			get
			{
			...
			set
			{
				BasereSENSIMapping mappedKey = this._mappedKey;
				if (this.SetProperty<BasereSENSIMapping>(ref this._mappedKey, value, "MappedKey"))
				{
		...
		public bool IsTurboOrTogglePeripheralCheck
		{
			get
			{
				...
				BasereSENSIMapping mappedKey = this.MappedKey;
		...
		public bool IsTurboOrToggleCanBeEnabled
		{
			get
			{
				...
				if (mappedKey == null || !mappedKey.IsNotMapped)
				{
					...
					{
						BasereSENSIMapping mappedKey2 = this.MappedKey;
						if (mappedKey2 == null || !mappedKey2.IsDoNotInherit)
						{
							BasereSENSIMapping mappedKey3 = this.MappedKey;
		...
		public ActivatorXBBinding(GamepadButton gb, ActivatorType at, MacroSequence ms, BasereSENSIMapping mappedKey = null, string d = "")
			: this(new AssociatedControllerButton
			{
				GamepadButton = gb
			}, at, ms, mappedKey, d)
		...
		public ActivatorXBBinding(GamepadButtonDescription gbd, ActivatorType at, MacroSequence ms, BasereSENSIMapping mappedKey = null, string d = "")
			: this(new AssociatedControllerButton
			{
		...
		public ActivatorXBBinding(KeyScanCodeV2 ksc, ActivatorType at, MacroSequence ms, BasereSENSIMapping mappedKey = null, string d = "")
			: this(new AssociatedControllerButton
			{
				KeyScanCode = ksc
			}, at, ms, mappedKey, d)
		...
		public ActivatorXBBinding(AssociatedControllerButton controllerButton, ActivatorType activatorType, MacroSequence macroSequence, BasereSENSIMapping mappedKey = null, string description = "")
			: this(controllerButton, activatorType)
		{
			...
			if (mappedKey != null)
			{
				...
				{
					BasereSENSIUserCommand basereSENSIUserCommand = mappedKey as BasereSENSIUserCommand;
					if (basereSENSIUserCommand != null)
					{
						this.MappedKey = basereSENSIUserCommand;
					}
					else
					{
						this.MappedKey = KeyScanCodeV2.NoMap;
		...
		private BasereSENSIMapping _mappedKey;
