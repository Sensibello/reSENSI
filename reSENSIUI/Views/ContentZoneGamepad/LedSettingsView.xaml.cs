...
namespace reSENSIUI.Views.ContentZoneGamepad
{
	public partial class LedSettingsView : UserControl
	{
		public LedSettingsView()
		{
			this.InitializeComponent();
			base.IsVisibleChanged += this.LedSettingsView_IsVisibleChanged;
		}

		private void LedSettingsView_IsVisibleChanged(object sender, DependencyPropertyChangedEventArgs e)
		{
			if ((bool)e.NewValue)
			{
