...
namespace reSENSIUI.Views.ContentZoneGamepad
{
	public partial class MouseSettings : UserControl
	{
		public MouseSettings()
		{
			...
			base.IsVisibleChanged += this.MouseSettings_IsVisibleChanged;
		}

		private void MouseSettings_IsVisibleChanged(object sender, DependencyPropertyChangedEventArgs e)
		{
			if ((bool)e.NewValue)
			{
