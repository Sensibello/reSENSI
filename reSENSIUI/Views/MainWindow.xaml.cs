...
using reSENSIUI.Controls.XBBindingControls.BindingFrame;
		...
		private void MainWindow_OnKeyDown(object sender, System.Windows.Input.KeyEventArgs e)
		{
			...
			if (comboBoxItem == null)
			{
				...
				else
				{
					...
					flag = coloredComboBox.ItemsSource is ObservableCollection<BasereSENSIMapping> || coloredComboBox.ItemsSource is ObservableCollection<KeyScanCodeV2>;
					if (!flag)
					{
						...
						flag = obj is ObservableCollection<BasereSENSIMapping> || obj is ObservableCollection<KeyScanCodeV2>;
					}
				}
			}
			else
