...
{
	public class EspInitializationAnimation : UserControl, IComponentConnector
	{
		public EspInitializationAnimation()
		{
		...
		public void InitializeComponent()
		{
			...
			Uri uri = new Uri("/reSENSI;component/views/secondarywindows/addexternaldevicewizard/animations/espinitializationanimation.xaml", UriKind.Relative);
