...
namespace reSENSIUI.Views.SecondaryWindows.AddExternalDeviceWizard
{
	public class AddNintendoSwitchConsoleStep2a : UserControl, IComponentConnector
	{
		...
		public void InitializeComponent()
		{
			...
			Uri uri = new Uri("/reSENSI;component/views/secondarywindows/addexternaldevicewizard/addnintendoswitch/addnintendoswitchconsolestep2a.xaml", UriKind.Relative);
