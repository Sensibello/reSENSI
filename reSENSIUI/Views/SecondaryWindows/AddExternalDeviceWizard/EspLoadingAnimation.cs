...
{
	public class EspLoadingAnimation : UserControl, IComponentConnector
	{
		public EspLoadingAnimation()
		{
		...
		public void InitializeComponent()
		{
			...
			Uri uri = new Uri("/reSENSI;component/views/secondarywindows/addexternaldevicewizard/animations/esploadinganimation.xaml", UriKind.Relative);
