...
using reSENSIUI.ViewModels.SecondaryWindows.AddExternalDeviceWizard;
...
namespace reSENSIUI.Views.SecondaryWindows.AddExternalDeviceWizard
{
	public partial class Wizard : BaseSecondaryWindow
	{
		...
		private static bool ShowEspError(ExternalDeviceType deviceType, FirmwareLoader.FirwareUpdateResult esptoolResult)
		{
			...
			{
				espFailsStageVM.EspFailsMessage = DTLocalization.GetString(12680) + Environment.NewLine + Environment.NewLine + string.Format(DTLocalization.GetString(12681), deviceType, "https://help.reSENSI.com/external-devices/esp32-bluetooth-adapter.html#native_drivers");
			}
			wizard.ShowDialog();
