...
{
	public class AddPS4ConsoleStep2 : UserControl, IComponentConnector
	{
		public AddPS4ConsoleStep2()
		{
		...
		public void InitializeComponent()
		{
			...
			Uri uri = new Uri("/reSENSI;component/views/secondarywindows/addexternaldevicewizard/addps4/addps4consolestep2.xaml", UriKind.Relative);
		...
		void IComponentConnector.Connect(int connectionId, object target)
		{
			...
			case 1:
				...
				return;
			case 2:
				this.ConnectDS4ToPcTB = (TextBlock)target;
				return;
			case 3:
		...
		internal TextBlock ConnectDS4ToPcTB;
