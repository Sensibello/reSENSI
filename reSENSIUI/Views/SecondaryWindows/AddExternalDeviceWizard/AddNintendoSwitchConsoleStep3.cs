...
namespace reSENSIUI.Views.SecondaryWindows.AddExternalDeviceWizard
{
	public class AddNintendoSwitchConsoleStep3 : UserControl, IComponentConnector
	{
		...
		public void InitializeComponent()
		{
			...
			Uri uri = new Uri("/reSENSI;component/views/secondarywindows/addexternaldevicewizard/addnintendoswitch/addnintendoswitchconsolestep3.xaml", UriKind.Relative);
